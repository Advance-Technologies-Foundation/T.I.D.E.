...
`)},"setAccDescription"),xf=y(()=>Vo,"getAccDescription"),yf=y(t=>{Go=Xo(t)},"setDiagramTitle"),Cf=y(()=>Go,"getDiagramTitle"),Va=it,_f=wu,as=Uo,V0=Uu,X0=ki,bf=y(t=>Mr(t,as()),"sanitizeText"),Tf=cf,kf=y(()=>ns,"getCommonDb"),_i={},j0=y((t,e,r)=>{_i[t]&&Va.warn(`Diagram with id ${t} already registered. Overwriting.`),_i[t]=e,r&&Za(t,r),ff(t,e.styles),e.injectUtils?.(Va,_f,as,bf,Tf,kf(),()=>{})},"registerDiagram"),Z0=y(t=>{if(t in _i)return _i[t];throw new Sf(t)},"getDiagram"),Sf=class extends Error{static{y(this,"DiagramNotFoundError")}constructor(t){super(`Diagram ${t} not found.`)}};function ss(t,e){let r;if(e===void 0)for(let i of t)i!=null&&(r<i||r===void 0&&i>=i)&&(r=i);else{let i=-1;for(let o of t)(o=e(o,++i,t))!=null&&(r<o||r===void 0&&o>=o)&&(r=o)}return r}function ls(t,e){let r;if(e===void 0)for(let i of t)i!=null&&(r>i||r===void 0&&i>=i)&&(r=i);else{let i=-1;for(let o of t)(o=e(o,++i,t))!=null&&(r>o||r===void 0&&o>=o)&&(r=o)}return r}function Be(t,e){return t==null||e==null?NaN:t<e?-1:t>e?1:t>=e?0:NaN}function jo(t,e){return t==null||e==null?NaN:e<t?-1:e>t?1:e>=t?0:NaN}function Fe(t){let e,r,i;t.length!==2?(e=Be,r=(s,h)=>Be(t(s),h),i=(s,h)=>t(s)-h):(e=t===Be||t===jo?t:vf,r=t,i=t);function o(s,h,l=0,c=s.length){if(l<c){if(e(h,h)!==0)return c;do{let d=l+c>>>1;r(s[d],h)<0?l=d+1:c=d}while(l<c)}return l}function n(s,h,l=0,c=s.length){if(l<c){if(e(h,h)!==0)return c;do{let d=l+c>>>1;r(s[d],h)<=0?l=d+1:c=d}while(l<c)}return l}function a(s,h,l=0,c=s.length){let d=o(s,h,l,c-1);return d>l&&i(s[d-1],h)>-i(s[d],h)?d-1:d}return{left:o,center:a,right:n}}function vf(){return 0}function Zo(t){return t===null?NaN:+t}var hs=Fe(Be),cs=hs.right,wf=hs.left,Bf=Fe(Zo).center,Ko=cs;var Je=class extends Map{constructor(e,r=Mf){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:r}}),e!=null)for(let[i,o]of e)this.set(i,o)}get(e){return super.get(us(this,e))}has(e){return super.has(us(this,e))}set(e,r){return super.set(Ff(this,e),r)}delete(e){return super.delete(Lf(this,e))}};function us({_intern:t,_key:e},r){let i=e(r);return t.has(i)?t.get(i):r}function Ff({_intern:t,_key:e},r){let i=e(r);return t.has(i)?t.get(i):(t.set(i,r),r)}function Lf({_intern:t,_key:e},r){let i=e(r);return t.has(i)&&(r=t.get(i),t.delete(i)),r}function Mf(t){return t!==null&&typeof t=="object"?t.valueOf():t}var Af=Math.sqrt(50),Ef=Math.sqrt(10),Df=Math.sqrt(2);function vi(t,e,r){let i=(e-t)/Math.max(0,r),o=Math.floor(Math.log10(i)),n=i/Math.pow(10,o),a=n>=Af?10:n>=Ef?5:n>=Df?2:1,s,h,l;return o<0?(l=Math.pow(10,-o)/a,s=Math.round(t*l),h=Math.round(e*l),s/l<t&&++s,h/l>e&&--h,l=-l):(l=Math.pow(10,o)*a,s=Math.round(t/l),h=Math.round(e/l),s*l<t&&++s,h*l>e&&--h),h<s&&.5<=r&&r<2?vi(t,e,r*2):[s,h,l]}function wi(t,e,r){if(e=+e,t=+t,r=+r,!(r>0))return[];if(t===e)return[t];let i=e<t,[o,n,a]=i?vi(e,t,r):vi(t,e,r);if(!(n>=o))return[];let s=n-o+1,h=new Array(s);if(i)if(a<0)for(let l=0;l<s;++l)h[l]=(n-l)/-a;else for(let l=0;l<s;++l)h[l]=(n-l)*a;else if(a<0)for(let l=0;l<s;++l)h[l]=(o+l)/-a;else for(let l=0;l<s;++l)h[l]=(o+l)*a;return h}function Er(t,e,r){return e=+e,t=+t,r=+r,vi(t,e,r)[2]}function tr(t,e,r){e=+e,t=+t,r=+r;let i=e<t,o=i?Er(e,t,r):Er(t,e,r);return(i?-1:1)*(o<0?1/-o:o)}function Bi(t,e,r){t=+t,e=+e,r=(o=arguments.length)<2?(e=t,t=0,1):o<3?1:+r;for(var i=-1,o=Math.max(0,Math.ceil((e-t)/r))|0,n=new Array(o);++i<o;)n[i]=t+i*r;return n}function fs(t){return t}var Li=1,Qo=2,Jo=3,Fi=4,ms=1e-6;function Of(t){return"translate("+t+",0)"}function If(t){return"translate(0,"+t+")"}function Nf(t){return e=>+t(e)}function Rf(t,e){return e=Math.max(0,t.bandwidth()-e*2)/2,t.round()&&(e=Math.round(e)),r=>+t(r)+e}function zf(){return!this.__axis}function ds(t,e){var r=[],i=null,o=null,n=6,a=6,s=3,h=typeof window<"u"&&window.devicePixelRatio>1?0:.5,l=t===Li||t===Fi?-1:1,c=t===Fi||t===Qo?"x":"y",d=t===Li||t===Jo?Of:If;function u(p){var T=i??(e.ticks?e.ticks.apply(e,r):e.domain()),M=o??(e.tickFormat?e.tickFormat.apply(e,r):fs),$=Math.max(n,0)+s,q=e.range(),G=+q[0]+h,E=+q[q.length-1]+h,F=(e.bandwidth?Rf:Nf)(e.copy(),h),P=p.selection?p.selection():p,w=P.selectAll(".domain").data([null]),X=P.selectAll(".tick").data(T,e).order(),j=X.exit(),W=X.enter().append("g").attr("class","tick"),rt=X.select("line"),B=X.select("text");w=w.merge(w.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),X=X.merge(W),rt=rt.merge(W.append("line").attr("stroke","currentColor").attr(c+"2",l*n)),B=B.merge(W.append("text").attr("fill","currentColor").attr(c,l*$).attr("dy",t===Li?"0em":t===Jo?"0.71em":"0.32em")),p!==P&&(w=w.transition(p),X=X.transition(p),rt=rt.transition(p),B=B.transition(p),j=j.transition(p).attr("opacity",ms).attr("transform",function(k){return isFinite(k=F(k))?d(k+h):this.getAttribute("transform")}),W.attr("opacity",ms).attr("transform",function(k){var g=this.parentNode.__axis;return d((g&&isFinite(g=g(k))?g:F(k))+h)})),j.remove(),w.attr("d",t===Fi||t===Qo?a?"M"+l*a+","+G+"H"+h+"V"+E+"H"+l*a:"M"+h+","+G+"V"+E:a?"M"+G+","+l*a+"V"+h+"H"+E+"V"+l*a:"M"+G+","+h+"H"+E),X.attr("opacity",1).attr("transform",function(k){return d(F(k)+h)}),rt.attr(c+"2",l*n),B.attr(c,l*$).text(M),P.filter(zf).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",t===Qo?"start":t===Fi?"end":"middle"),P.each(function(){this.__axis=F})}return u.scale=function(p){return arguments.length?(e=p,u):e},u.ticks=function(){return r=Array.from(arguments),u},u.tickArguments=function(p){return arguments.length?(r=p==null?[]:Array.from(p),u):r.slice()},u.tickValues=function(p){return arguments.length?(i=p==null?null:Array.from(p),u):i&&i.slice()},u.tickFormat=function(p){return arguments.length?(o=p,u):o},u.tickSize=function(p){return arguments.length?(n=a=+p,u):n},u.tickSizeInner=function(p){return arguments.length?(n=+p,u):n},u.tickSizeOuter=function(p){return arguments.length?(a=+p,u):a},u.tickPadding=function(p){return arguments.length?(s=+p,u):s},u.offset=function(p){return arguments.length?(h=+p,u):h},u}function qf(t){return ds(Li,t)}function Pf(t){return ds(Jo,t)}function $f(){}function Le(t){return t==null?$f:function(){return this.querySelector(t)}}function ps(t){typeof t!="function"&&(t=Le(t));for(var e=this._groups,r=e.length,i=new Array(r),o=0;o<r;++o)for(var n=e[o],a=n.length,s=i[o]=new Array(a),h,l,c=0;c<a;++c)(h=n[c])&&(l=t.call(h,h.__data__,c,n))&&("__data__"in h&&(l.__data__=h.__data__),s[c]=l);return new ht(i,this._parents)}function tn(t){return t==null?[]:Array.isArray(t)?t:Array.from(t)}function Wf(){return[]}function Dr(t){return t==null?Wf:function(){return this.querySelectorAll(t)}}function Hf(t){return function(){return tn(t.apply(this,arguments))}}function gs(t){typeof t=="function"?t=Hf(t):t=Dr(t);for(var e=this._groups,r=e.length,i=[],o=[],n=0;n<r;++n)for(var a=e[n],s=a.length,h,l=0;l<s;++l)(h=a[l])&&(i.push(t.call(h,h.__data__,l,a)),o.push(h));return new ht(i,o)}function Or(t){return function(){return this.matches(t)}}function Mi(t){return function(e){return e.matches(t)}}var Uf=Array.prototype.find;function Yf(t){return function(){return Uf.call(this.children,t)}}function Gf(){return this.firstElementChild}function xs(t){return this.select(t==null?Gf:Yf(typeof t=="function"?t:Mi(t)))}var Vf=Array.prototype.filter;function Xf(){return Array.from(this.children)}function jf(t){return function(){return Vf.call(this.children,t)}}function ys(t){return this.selectAll(t==null?Xf:jf(typeof t=="function"?t:Mi(t)))}function Cs(t){typeof t!="function"&&(t=Or(t));for(var e=this._groups,r=e.length,i=new Array(r),o=0;o<r;++o)for(var n=e[o],a=n.length,s=i[o]=[],h,l=0;l<a;++l)(h=n[l])&&t.call(h,h.__data__,l,n)&&s.push(h);return new ht(i,this._parents)}function Ai(t){return new Array(t.length)}function _s(){return new ht(this._enter||this._groups.map(Ai),this._parents)}function Ir(t,e){this.ownerDocument=t.ownerDocument,this.namespaceURI=t.namespaceURI,this._next=null,this._parent=t,this.__data__=e}Ir.prototype={constructor:Ir,appendChild:function(t){return this._parent.insertBefore(t,this._next)},insertBefore:function(t,e){return this._parent.insertBefore(t,e)},querySelector:function(t){return this._parent.querySelector(t)},querySelectorAll:function(t){return this._parent.querySelectorAll(t)}};function bs(t){return function(){return t}}function Zf(t,e,r,i,o,n){for(var a=0,s,h=e.length,l=n.length;a<l;++a)(s=e[a])?(s.__data__=n[a],i[a]=s):r[a]=new Ir(t,n[a]);for(;a<h;++a)(s=e[a])&&(o[a]=s)}function Kf(t,e,r,i,o,n,a){var s,h,l=new Map,c=e.length,d=n.length,u=new Array(c),p;for(s=0;s<c;++s)(h=e[s])&&(u[s]=p=a.call(h,h.__data__,s,e)+"",l.has(p)?o[s]=h:l.set(p,h));for(s=0;s<d;++s)p=a.call(t,n[s],s,n)+"",(h=l.get(p))?(i[s]=h,h.__data__=n[s],l.delete(p)):r[s]=new Ir(t,n[s]);for(s=0;s<c;++s)(h=e[s])&&l.get(u[s])===h&&(o[s]=h)}function Qf(t){return t.__data__}function Ts(t,e){if(!arguments.length)return Array.from(this,Qf);var r=e?Kf:Zf,i=this._parents,o=this._groups;typeof t!="function"&&(t=bs(t));for(var n=o.length,a=new Array(n),s=new Array(n),h=new Array(n),l=0;l<n;++l){var c=i[l],d=o[l],u=d.length,p=Jf(t.call(c,c&&c.__data__,l,i)),T=p.length,M=s[l]=new Array(T),$=a[l]=new Array(T),q=h[l]=new Array(u);r(c,d,M,$,q,p,e);for(var G=0,E=0,F,P;G<T;++G)if(F=M[G]){for(G>=E&&(E=G+1);!(P=$[E])&&++E<T;);F._next=P||null}}return a=new ht(a,i),a._enter=s,a._exit=h,a}function Jf(t){return typeof t=="object"&&"length"in t?t:Array.from(t)}function ks(){return new ht(this._exit||this._groups.map(Ai),this._parents)}function Ss(t,e,r){var i=this.enter(),o=this,n=this.exit();return typeof t=="function"?(i=t(i),i&&(i=i.selection())):i=i.append(t+""),e!=null&&(o=e(o),o&&(o=o.selection())),r==null?n.remove():r(n),i&&o?i.merge(o).order():o}function vs(t){for(var e=t.selection?t.selection():t,r=this._groups,i=e._groups,o=r.length,n=i.length,a=Math.min(o,n),s=new Array(o),h=0;h<a;++h)for(var l=r[h],c=i[h],d=l.length,u=s[h]=new Array(d),p,T=0;T<d;++T)(p=l[T]||c[T])&&(u[T]=p);for(;h<o;++h)s[h]=r[h];return new ht(s,this._parents)}function ws(){for(var t=this._groups,e=-1,r=t.length;++e<r;)for(var i=t[e],o=i.length-1,n=i[o],a;--o>=0;)(a=i[o])&&(n&&a.compareDocumentPosition(n)^4&&n.parentNode.insertBefore(a,n),n=a);return this}function Bs(t){t||(t=tm);function e(d,u){return d&&u?t(d.__data__,u.__data__):!d-!u}for(var r=this._groups,i=r.length,o=new Array(i),n=0;n<i;++n){for(var a=r[n],s=a.length,h=o[n]=new Array(s),l,c=0;c<s;++c)(l=a[c])&&(h[c]=l);h.sort(e)}return new ht(o,this._parents).order()}function tm(t,e){return t<e?-1:t>e?1:t>=e?0:NaN}function Fs(){var t=arguments[0];return arguments[0]=this,t.apply(null,arguments),this}function Ls(){return Array.from(this)}function Ms(){for(var t=this._groups,e=0,r=t.length;e<r;++e)for(var i=t[e],o=0,n=i.length;o<n;++o){var a=i[o];if(a)return a}return null}function As(){let t=0;for(let e of this)++t;return t}function Es(){return!this.node()}function Ds(t){for(var e=this._groups,r=0,i=e.length;r<i;++r)for(var o=e[r],n=0,a=o.length,s;n<a;++n)(s=o[n])&&t.call(s,s.__data__,n,o);return this}var Ei="http://www.w3.org/1999/xhtml",en={svg:"http://www.w3.org/2000/svg",xhtml:Ei,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function ae(t){var e=t+="",r=e.indexOf(":");return r>=0&&(e=t.slice(0,r))!=="xmlns"&&(t=t.slice(r+1)),en.hasOwnProperty(e)?{space:en[e],local:t}:t}function em(t){return function(){this.removeAttribute(t)}}function rm(t){return function(){this.removeAttributeNS(t.space,t.local)}}function im(t,e){return function(){this.setAttribute(t,e)}}function om(t,e){return function(){this.setAttributeNS(t.space,t.local,e)}}function nm(t,e){return function(){var r=e.apply(this,arguments);r==null?this.removeAttribute(t):this.setAttribute(t,r)}}function am(t,e){return function(){var r=e.apply(this,arguments);r==null?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,r)}}function Os(t,e){var r=ae(t);if(arguments.length<2){var i=this.node();return r.local?i.getAttributeNS(r.space,r.local):i.getAttribute(r)}return this.each((e==null?r.local?rm:em:typeof e=="function"?r.local?am:nm:r.local?om:im)(r,e))}function Di(t){return t.ownerDocument&&t.ownerDocument.defaultView||t.document&&t||t.defaultView}function sm(t){return function(){this.style.removeProperty(t)}}function lm(t,e,r){return function(){this.style.setProperty(t,e,r)}}function hm(t,e,r){return function(){var i=e.apply(this,arguments);i==null?this.style.removeProperty(t):this.style.setProperty(t,i,r)}}function Is(t,e,r){return arguments.length>1?this.each((e==null?sm:typeof e=="function"?hm:lm)(t,e,r??"")):pe(this.node(),t)}function pe(t,e){return t.style.getPropertyValue(e)||Di(t).getComputedStyle(t,null).getPropertyValue(e)}function cm(t){return function(){delete this[t]}}function um(t,e){return function(){this[t]=e}}function fm(t,e){return function(){var r=e.apply(this,arguments);r==null?delete this[t]:this[t]=r}}function Ns(t,e){return arguments.length>1?this.each((e==null?cm:typeof e=="function"?fm:um)(t,e)):this.node()[t]}function Rs(t){return t.trim().split(/^|\s+/)}function rn(t){return t.classList||new zs(t)}function zs(t){this._node=t,this._names=Rs(t.getAttribute("class")||"")}zs.prototype={add:function(t){var e=this._names.indexOf(t);e<0&&(this._names.push(t),this._node.setAttribute("class",this._names.join(" ")))},remove:function(t){var e=this._names.indexOf(t);e>=0&&(this._names.splice(e,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(t){return this._names.indexOf(t)>=0}};function qs(t,e){for(var r=rn(t),i=-1,o=e.length;++i<o;)r.add(e[i])}function Ps(t,e){for(var r=rn(t),i=-1,o=e.length;++i<o;)r.remove(e[i])}function mm(t){return function(){qs(this,t)}}function dm(t){return function(){Ps(this,t)}}function pm(t,e){return function(){(e.apply(this,arguments)?qs:Ps)(this,t)}}function $s(t,e){var r=Rs(t+"");if(arguments.length<2){for(var i=rn(this.node()),o=-1,n=r.length;++o<n;)if(!i.contains(r[o]))return!1;return!0}return this.each((typeof e=="function"?pm:e?mm:dm)(r,e))}function gm(){this.textContent=""}function xm(t){return function(){this.textContent=t}}function ym(t){return function(){var e=t.apply(this,arguments);this.textContent=e??""}}function Ws(t){return arguments.length?this.each(t==null?gm:(typeof t=="function"?ym:xm)(t)):this.node().textContent}function Cm(){this.innerHTML=""}function _m(t){return function(){this.innerHTML=t}}function bm(t){return function(){var e=t.apply(this,arguments);this.innerHTML=e??""}}function Hs(t){return arguments.length?this.each(t==null?Cm:(typeof t=="function"?bm:_m)(t)):this.node().innerHTML}function Tm(){this.nextSibling&&this.parentNode.appendChild(this)}function Us(){return this.each(Tm)}function km(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Ys(){return this.each(km)}function Sm(t){return function(){var e=this.ownerDocument,r=this.namespaceURI;return r===Ei&&e.documentElement.namespaceURI===Ei?e.createElement(t):e.createElementNS(r,t)}}function vm(t){return function(){return this.ownerDocument.createElementNS(t.space,t.local)}}function Oi(t){var e=ae(t);return(e.local?vm:Sm)(e)}function Gs(t){var e=typeof t=="function"?t:Oi(t);return this.select(function(){return this.appendChild(e.apply(this,arguments))})}function wm(){return null}function Vs(t,e){var r=typeof t=="function"?t:Oi(t),i=e==null?wm:typeof e=="function"?e:Le(e);return this.select(function(){return this.insertBefore(r.apply(this,arguments),i.apply(this,arguments)||null)})}function Bm(){var t=this.parentNode;t&&t.removeChild(this)}function Xs(){return this.each(Bm)}function Fm(){var t=this.cloneNode(!1),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function Lm(){var t=this.cloneNode(!0),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function js(t){return this.select(t?Lm:Fm)}function Zs(t){return arguments.length?this.property("__data__",t):this.node().__data__}function Mm(t){return function(e){t.call(this,e,this.__data__)}}function Am(t){return t.trim().split(/^|\s+/).map(function(e){var r="",i=e.indexOf(".");return i>=0&&(r=e.slice(i+1),e=e.slice(0,i)),{type:e,name:r}})}function Em(t){return function(){var e=this.__on;if(e){for(var r=0,i=-1,o=e.length,n;r<o;++r)n=e[r],(!t.type||n.type===t.type)&&n.name===t.name?this.removeEventListener(n.type,n.listener,n.options):e[++i]=n;++i?e.length=i:delete this.__on}}}function Dm(t,e,r){return function(){var i=this.__on,o,n=Mm(e);if(i){for(var a=0,s=i.length;a<s;++a)if((o=i[a]).type===t.type&&o.name===t.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=n,o.options=r),o.value=e;return}}this.addEventListener(t.type,n,r),o={type:t.type,name:t.name,value:e,listener:n,options:r},i?i.push(o):this.__on=[o]}}function Ks(t,e,r){var i=Am(t+""),o,n=i.length,a;if(arguments.length<2){var s=this.node().__on;if(s){for(var h=0,l=s.length,c;h<l;++h)for(o=0,c=s[h];o<n;++o)if((a=i[o]).type===c.type&&a.name===c.name)return c.value}return}for(s=e?Dm:Em,o=0;o<n;++o)this.each(s(i[o],e,r));return this}function Qs(t,e,r){var i=Di(t),o=i.CustomEvent;typeof o=="function"?o=new o(e,r):(o=i.document.createEvent("Event"),r?(o.initEvent(e,r.bubbles,r.cancelable),o.detail=r.detail):o.initEvent(e,!1,!1)),t.dispatchEvent(o)}function Om(t,e){return function(){return Qs(this,t,e)}}function Im(t,e){return function(){return Qs(this,t,e.apply(this,arguments))}}function Js(t,e){return this.each((typeof e=="function"?Im:Om)(t,e))}function*tl(){for(var t=this._groups,e=0,r=t.length;e<r;++e)for(var i=t[e],o=0,n=i.length,a;o<n;++o)(a=i[o])&&(yield a)}var on=[null];function ht(t,e){this._groups=t,this._parents=e}function el(){return new ht([[document.documentElement]],on)}function Nm(){return this}ht.prototype=el.prototype={constructor:ht,select:ps,selectAll:gs,selectChild:xs,selectChildren:ys,filter:Cs,data:Ts,enter:_s,exit:ks,join:Ss,merge:vs,selection:Nm,order:ws,sort:Bs,call:Fs,nodes:Ls,node:Ms,size:As,empty:Es,each:Ds,attr:Os,style:Is,property:Ns,classed:$s,text:Ws,html:Hs,raise:Us,lower:Ys,append:Gs,insert:Vs,remove:Xs,clone:js,datum:Zs,on:Ks,dispatch:Js,[Symbol.iterator]:tl};var se=el;function Rm(t){return typeof t=="string"?new ht([[document.querySelector(t)]],[document.documentElement]):new ht([[t]],on)}function Me(t,e,r){t.prototype=e.prototype=r,r.constructor=t}function er(t,e){var r=Object.create(t.prototype);for(var i in e)r[i]=e[i];return r}function ge(){}var Nr=.7,Ri=1/Nr,rr="\\s*([+-]?\\d+)\\s*",Rr="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",Zt="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",zm=/^#([0-9a-f]{3,8})$/,qm=new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`),Pm=new RegExp(`^rgb\\(${Zt},${Zt},${Zt}\\)$`),$m=new RegExp(`^rgba\\(${rr},${rr},${rr},${Rr}\\)$`),Wm=new RegExp(`^rgba\\(${Zt},${Zt},${Zt},${Rr}\\)$`),Hm=new RegExp(`^hsl\\(${Rr},${Zt},${Zt}\\)$`),Um=new RegExp(`^hsla\\(${Rr},${Zt},${Zt},${Rr}\\)$`),rl={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Me(ge,Yt,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:il,formatHex:il,formatHex8:Ym,formatHsl:Gm,formatRgb:ol,toString:ol});function il(){return this.rgb().formatHex()}function Ym(){return this.rgb().formatHex8()}function Gm(){return cl(this).formatHsl()}function ol(){return this.rgb().formatRgb()}function Yt(t){var e,r;return t=(t+"").trim().toLowerCase(),(e=zm.exec(t))?(r=e[1].length,e=parseInt(e[1],16),r===6?nl(e):r===3?new Tt(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):r===8?Ii(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):r===4?Ii(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=qm.exec(t))?new Tt(e[1],e[2],e[3],1):(e=Pm.exec(t))?new Tt(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=$m.exec(t))?Ii(e[1],e[2],e[3],e[4]):(e=Wm.exec(t))?Ii(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=Hm.exec(t))?ll(e[1],e[2]/100,e[3]/100,1):(e=Um.exec(t))?ll(e[1],e[2]/100,e[3]/100,e[4]):rl.hasOwnProperty(t)?nl(rl[t]):t==="transparent"?new Tt(NaN,NaN,NaN,0):null}function nl(t){return new Tt(t>>16&255,t>>8&255,t&255,1)}function Ii(t,e,r,i){return i<=0&&(t=e=r=NaN),new Tt(t,e,r,i)}function an(t){return t instanceof ge||(t=Yt(t)),t?(t=t.rgb(),new Tt(t.r,t.g,t.b,t.opacity)):new Tt}function ir(t,e,r,i){return arguments.length===1?an(t):new Tt(t,e,r,i??1)}function Tt(t,e,r,i){this.r=+t,this.g=+e,this.b=+r,this.opacity=+i}Me(Tt,ir,er(ge,{brighter(t){return t=t==null?Ri:Math.pow(Ri,t),new Tt(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?Nr:Math.pow(Nr,t),new Tt(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new Tt(Ee(this.r),Ee(this.g),Ee(this.b),zi(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:al,formatHex:al,formatHex8:Vm,formatRgb:sl,toString:sl}));function al(){return`#${Ae(this.r)}${Ae(this.g)}${Ae(this.b)}`}function Vm(){return`#${Ae(this.r)}${Ae(this.g)}${Ae(this.b)}${Ae((isNaN(this.opacity)?1:this.opacity)*255)}`}function sl(){let t=zi(this.opacity);return`${t===1?"rgb(":"rgba("}${Ee(this.r)}, ${Ee(this.g)}, ${Ee(this.b)}${t===1?")":`, ${t})`}`}function zi(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function Ee(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function Ae(t){return t=Ee(t),(t<16?"0":"")+t.toString(16)}function ll(t,e,r,i){return i<=0?t=e=r=NaN:r<=0||r>=1?t=e=NaN:e<=0&&(t=NaN),new Ut(t,e,r,i)}function cl(t){if(t instanceof Ut)return new Ut(t.h,t.s,t.l,t.opacity);if(t instanceof ge||(t=Yt(t)),!t)return new Ut;if(t instanceof Ut)return t;t=t.rgb();var e=t.r/255,r=t.g/255,i=t.b/255,o=Math.min(e,r,i),n=Math.max(e,r,i),a=NaN,s=n-o,h=(n+o)/2;return s?(e===n?a=(r-i)/s+(r<i)*6:r===n?a=(i-e)/s+2:a=(e-r)/s+4,s/=h<.5?n+o:2-n-o,a*=60):s=h>0&&h<1?0:a,new Ut(a,s,h,t.opacity)}function ul(t,e,r,i){return arguments.length===1?cl(t):new Ut(t,e,r,i??1)}function Ut(t,e,r,i){this.h=+t,this.s=+e,this.l=+r,this.opacity=+i}Me(Ut,ul,er(ge,{brighter(t){return t=t==null?Ri:Math.pow(Ri,t),new Ut(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?Nr:Math.pow(Nr,t),new Ut(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,r=this.l,i=r+(r<.5?r:1-r)*e,o=2*r-i;return new Tt(nn(t>=240?t-240:t+120,o,i),nn(t,o,i),nn(t<120?t+240:t-120,o,i),this.opacity)},clamp(){return new Ut(hl(this.h),Ni(this.s),Ni(this.l),zi(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){let t=zi(this.opacity);return`${t===1?"hsl(":"hsla("}${hl(this.h)}, ${Ni(this.s)*100}%, ${Ni(this.l)*100}%${t===1?")":`, ${t})`}`}}));function hl(t){return t=(t||0)%360,t<0?t+360:t}function Ni(t){return Math.max(0,Math.min(1,t||0))}function nn(t,e,r){return(t<60?e+(r-e)*t/60:t<180?r:t<240?e+(r-e)*(240-t)/60:e)*255}var fl=Math.PI/180,ml=180/Math.PI;var qi=18,dl=.96422,pl=1,gl=.82521,xl=4/29,or=6/29,yl=3*or*or,Xm=or*or*or;function Cl(t){if(t instanceof Kt)return new Kt(t.l,t.a,t.b,t.opacity);if(t instanceof le)return _l(t);t instanceof Tt||(t=an(t));var e=cn(t.r),r=cn(t.g),i=cn(t.b),o=sn((.2225045*e+.7168786*r+.0606169*i)/pl),n,a;return e===r&&r===i?n=a=o:(n=sn((.4360747*e+.3850649*r+.1430804*i)/dl),a=sn((.0139322*e+.0971045*r+.7141733*i)/gl)),new Kt(116*o-16,500*(n-o),200*(o-a),t.opacity)}function un(t,e,r,i){return arguments.length===1?Cl(t):new Kt(t,e,r,i??1)}function Kt(t,e,r,i){this.l=+t,this.a=+e,this.b=+r,this.opacity=+i}Me(Kt,un,er(ge,{brighter(t){return new Kt(this.l+qi*(t??1),this.a,this.b,this.opacity)},darker(t){return new Kt(this.l-qi*(t??1),this.a,this.b,this.opacity)},rgb(){var t=(this.l+16)/116,e=isNaN(this.a)?t:t+this.a/500,r=isNaN(this.b)?t:t-this.b/200;return e=dl*ln(e),t=pl*ln(t),r=gl*ln(r),new Tt(hn(3.1338561*e-1.6168667*t-.4906146*r),hn(-.9787684*e+1.9161415*t+.033454*r),hn(.0719453*e-.2289914*t+1.4052427*r),this.opacity)}}));function sn(t){return t>Xm?Math.pow(t,1/3):t/yl+xl}function ln(t){return t>or?t*t*t:yl*(t-xl)}function hn(t){return 255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)}function cn(t){return(t/=255)<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function jm(t){if(t instanceof le)return new le(t.h,t.c,t.l,t.opacity);if(t instanceof Kt||(t=Cl(t)),t.a===0&&t.b===0)return new le(NaN,0<t.l&&t.l<100?0:NaN,t.l,t.opacity);var e=Math.atan2(t.b,t.a)*ml;return new le(e<0?e+360:e,Math.sqrt(t.a*t.a+t.b*t.b),t.l,t.opacity)}function zr(t,e,r,i){return arguments.length===1?jm(t):new le(t,e,r,i??1)}function le(t,e,r,i){this.h=+t,this.c=+e,this.l=+r,this.opacity=+i}function _l(t){if(isNaN(t.h))return new Kt(t.l,0,0,t.opacity);var e=t.h*fl;return new Kt(t.l,Math.cos(e)*t.c,Math.sin(e)*t.c,t.opacity)}Me(le,zr,er(ge,{brighter(t){return new le(this.h,this.c,this.l+qi*(t??1),this.opacity)},darker(t){return new le(this.h,this.c,this.l-qi*(t??1),this.opacity)},rgb(){return _l(this).rgb()}}));var nr=t=>()=>t;function bl(t,e){return function(r){return t+r*e}}function Zm(t,e,r){return t=Math.pow(t,r),e=Math.pow(e,r)-t,r=1/r,function(i){return Math.pow(t+i*e,r)}}function Tl(t,e){var r=e-t;return r?bl(t,r>180||r<-180?r-360*Math.round(r/360):r):nr(isNaN(t)?e:t)}function kl(t){return(t=+t)==1?he:function(e,r){return r-e?Zm(e,r,t):nr(isNaN(e)?r:e)}}function he(t,e){var r=e-t;return r?bl(t,r):nr(isNaN(t)?e:t)}function Sl(t){return function(e,r){var i=t((e=zr(e)).h,(r=zr(r)).h),o=he(e.c,r.c),n=he(e.l,r.l),a=he(e.opacity,r.opacity);return function(s){return e.h=i(s),e.c=o(s),e.l=n(s),e.opacity=a(s),e+""}}}var Km=Sl(Tl),Qm=Sl(he);function fn(t,e,r,i,o){var n=t*t,a=n*t;return((1-3*t+3*n-a)*e+(4-6*n+3*a)*r+(1+3*t+3*n-3*a)*i+a*o)/6}function vl(t){var e=t.length-1;return function(r){var i=r<=0?r=0:r>=1?(r=1,e-1):Math.floor(r*e),o=t[i],n=t[i+1],a=i>0?t[i-1]:2*o-n,s=i<e-1?t[i+2]:2*n-o;return fn((r-i/e)*e,a,o,n,s)}}function wl(t){var e=t.length;return function(r){var i=Math.floor(((r%=1)<0?++r:r)*e),o=t[(i+e-1)%e],n=t[i%e],a=t[(i+1)%e],s=t[(i+2)%e];return fn((r-i/e)*e,o,n,a,s)}}var De=function t(e){var r=kl(e);function i(o,n){var a=r((o=ir(o)).r,(n=ir(n)).r),s=r(o.g,n.g),h=r(o.b,n.b),l=he(o.opacity,n.opacity);return function(c){return o.r=a(c),o.g=s(c),o.b=h(c),o.opacity=l(c),o+""}}return i.gamma=t,i}(1);function Bl(t){return function(e){var r=e.length,i=new Array(r),o=new Array(r),n=new Array(r),a,s;for(a=0;a<r;++a)s=ir(e[a]),i[a]=s.r||0,o[a]=s.g||0,n[a]=s.b||0;return i=t(i),o=t(o),n=t(n),s.opacity=1,function(h){return s.r=i(h),s.g=o(h),s.b=n(h),s+""}}}var Jm=Bl(vl),td=Bl(wl);function Fl(t,e){e||(e=[]);var r=t?Math.min(e.length,t.length):0,i=e.slice(),o;return function(n){for(o=0;o<r;++o)i[o]=t[o]*(1-n)+e[o]*n;return i}}function Ll(t){return ArrayBuffer.isView(t)&&!(t instanceof DataView)}function Ml(t,e){var r=e?e.length:0,i=t?Math.min(r,t.length):0,o=new Array(i),n=new Array(r),a;for(a=0;a<i;++a)o[a]=Oe(t[a],e[a]);for(;a<r;++a)n[a]=e[a];return function(s){for(a=0;a<i;++a)n[a]=o[a](s);return n}}function Al(t,e){var r=new Date;return t=+t,e=+e,function(i){return r.setTime(t*(1-i)+e*i),r}}function kt(t,e){return t=+t,e=+e,function(r){return t*(1-r)+e*r}}function El(t,e){var r={},i={},o;(t===null||typeof t!="object")&&(t={}),(e===null||typeof e!="object")&&(e={});for(o in e)o in t?r[o]=Oe(t[o],e[o]):i[o]=e[o];return function(n){for(o in r)i[o]=r[o](n);return i}}var dn=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,mn=new RegExp(dn.source,"g");function ed(t){return function(){return t}}function rd(t){return function(e){return t(e)+""}}function qr(t,e){var r=dn.lastIndex=mn.lastIndex=0,i,o,n,a=-1,s=[],h=[];for(t=t+"",e=e+"";(i=dn.exec(t))&&(o=mn.exec(e));)(n=o.index)>r&&(n=e.slice(r,n),s[a]?s[a]+=n:s[++a]=n),(i=i[0])===(o=o[0])?s[a]?s[a]+=o:s[++a]=o:(s[++a]=null,h.push({i:a,x:kt(i,o)})),r=mn.lastIndex;return r<e.length&&(n=e.slice(r),s[a]?s[a]+=n:s[++a]=n),s.length<2?h[0]?rd(h[0].x):ed(e):(e=h.length,function(l){for(var c=0,d;c<e;++c)s[(d=h[c]).i]=d.x(l);return s.join("")})}function Oe(t,e){var r=typeof e,i;return e==null||r==="boolean"?nr(e):(r==="number"?kt:r==="string"?(i=Yt(e))?(e=i,De):qr:e instanceof Yt?De:e instanceof Date?Al:Ll(e)?Fl:Array.isArray(e)?Ml:typeof e.valueOf!="function"&&typeof e.toString!="function"||isNaN(e)?El:kt)(t,e)}function pn(t,e){return t=+t,e=+e,function(r){return Math.round(t*(1-r)+e*r)}}var Dl=180/Math.PI,Pi={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function gn(t,e,r,i,o,n){var a,s,h;return(a=Math.sqrt(t*t+e*e))&&(t/=a,e/=a),(h=t*r+e*i)&&(r-=t*h,i-=e*h),(s=Math.sqrt(r*r+i*i))&&(r/=s,i/=s,h/=s),t*i<e*r&&(t=-t,e=-e,h=-h,a=-a),{translateX:o,translateY:n,rotate:Math.atan2(e,t)*Dl,skewX:Math.atan(h)*Dl,scaleX:a,scaleY:s}}var $i;function Ol(t){let e=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(t+"");return e.isIdentity?Pi:gn(e.a,e.b,e.c,e.d,e.e,e.f)}function Il(t){return t==null?Pi:($i||($i=document.createElementNS("http://www.w3.org/2000/svg","g")),$i.setAttribute("transform",t),(t=$i.transform.baseVal.consolidate())?(t=t.matrix,gn(t.a,t.b,t.c,t.d,t.e,t.f)):Pi)}function Nl(t,e,r,i){function o(l){return l.length?l.pop()+" ":""}function n(l,c,d,u,p,T){if(l!==d||c!==u){var M=p.push("translate(",null,e,null,r);T.push({i:M-4,x:kt(l,d)},{i:M-2,x:kt(c,u)})}else(d||u)&&p.push("translate("+d+e+u+r)}function a(l,c,d,u){l!==c?(l-c>180?c+=360:c-l>180&&(l+=360),u.push({i:d.push(o(d)+"rotate(",null,i)-2,x:kt(l,c)})):c&&d.push(o(d)+"rotate("+c+i)}function s(l,c,d,u){l!==c?u.push({i:d.push(o(d)+"skewX(",null,i)-2,x:kt(l,c)}):c&&d.push(o(d)+"skewX("+c+i)}function h(l,c,d,u,p,T){if(l!==d||c!==u){var M=p.push(o(p)+"scale(",null,",",null,")");T.push({i:M-4,x:kt(l,d)},{i:M-2,x:kt(c,u)})}else(d!==1||u!==1)&&p.push(o(p)+"scale("+d+","+u+")")}return function(l,c){var d=[],u=[];return l=t(l),c=t(c),n(l.translateX,l.translateY,c.translateX,c.translateY,d,u),a(l.rotate,c.rotate,d,u),s(l.skewX,c.skewX,d,u),h(l.scaleX,l.scaleY,c.scaleX,c.scaleY,d,u),l=c=null,function(p){for(var T=-1,M=u.length,$;++T<M;)d[($=u[T]).i]=$.x(p);return d.join("")}}}var xn=Nl(Ol,"px, ","px)","deg)"),yn=Nl(Il,", ",")",")");function xe(t,e){switch(arguments.length){case 0:break;case 1:this.range(t);break;default:this.range(e).domain(t);break}return this}var Cn=Symbol("implicit");function Pr(){var t=new Je,e=[],r=[],i=Cn;function o(n){let a=t.get(n);if(a===void 0){if(i!==Cn)return i;t.set(n,a=e.push(n)-1)}return r[a%r.length]}return o.domain=function(n){if(!arguments.length)return e.slice();e=[],t=new Je;for(let a of n)t.has(a)||t.set(a,e.push(a)-1);return o},o.range=function(n){return arguments.length?(r=Array.from(n),o):r.slice()},o.unknown=function(n){return arguments.length?(i=n,o):i},o.copy=function(){return Pr(e,r).unknown(i)},xe.apply(o,arguments),o}function _n(){var t=Pr().unknown(void 0),e=t.domain,r=t.range,i=0,o=1,n,a,s=!1,h=0,l=0,c=.5;delete t.unknown;function d(){var u=e().length,p=o<i,T=p?o:i,M=p?i:o;n=(M-T)/Math.max(1,u-h+l*2),s&&(n=Math.floor(n)),T+=(M-T-n*(u-h))*c,a=n*(1-h),s&&(T=Math.round(T),a=Math.round(a));var $=Bi(u).map(function(q){return T+n*q});return r(p?$.reverse():$)}return t.domain=function(u){return arguments.length?(e(u),d()):e()},t.range=function(u){return arguments.length?([i,o]=u,i=+i,o=+o,d()):[i,o]},t.rangeRound=function(u){return[i,o]=u,i=+i,o=+o,s=!0,d()},t.bandwidth=function(){return a},t.step=function(){return n},t.round=function(u){return arguments.length?(s=!!u,d()):s},t.padding=function(u){return arguments.length?(h=Math.min(1,l=+u),d()):h},t.paddingInner=function(u){return arguments.length?(h=Math.min(1,u),d()):h},t.paddingOuter=function(u){return arguments.length?(l=+u,d()):l},t.align=function(u){return arguments.length?(c=Math.max(0,Math.min(1,u)),d()):c},t.copy=function(){return _n(e(),[i,o]).round(s).paddingInner(h).paddingOuter(l).align(c)},xe.apply(d(),arguments)}function bn(t){return function(){return t}}function Tn(t){return+t}var Rl=[0,1];function ar(t){return t}function kn(t,e){return(e-=t=+t)?function(r){return(r-t)/e}:bn(isNaN(e)?NaN:.5)}function id(t,e){var r;return t>e&&(r=t,t=e,e=r),function(i){return Math.max(t,Math.min(e,i))}}function od(t,e,r){var i=t[0],o=t[1],n=e[0],a=e[1];return o<i?(i=kn(o,i),n=r(a,n)):(i=kn(i,o),n=r(n,a)),function(s){return n(i(s))}}function nd(t,e,r){var i=Math.min(t.length,e.length)-1,o=new Array(i),n=new Array(i),a=-1;for(t[i]<t[0]&&(t=t.slice().reverse(),e=e.slice().reverse());++a<i;)o[a]=kn(t[a],t[a+1]),n[a]=r(e[a],e[a+1]);return function(s){var h=Ko(t,s,1,i)-1;return n[h](o[h](s))}}function Wi(t,e){return e.domain(t.domain()).range(t.range()).interpolate(t.interpolate()).clamp(t.clamp()).unknown(t.unknown())}function ad(){var t=Rl,e=Rl,r=Oe,i,o,n,a=ar,s,h,l;function c(){var u=Math.min(t.length,e.length);return a!==ar&&(a=id(t[0],t[u-1])),s=u>2?nd:od,h=l=null,d}function d(u){return u==null||isNaN(u=+u)?n:(h||(h=s(t.map(i),e,r)))(i(a(u)))}return d.invert=function(u){return a(o((l||(l=s(e,t.map(i),kt)))(u)))},d.domain=function(u){return arguments.length?(t=Array.from(u,Tn),c()):t.slice()},d.range=function(u){return arguments.length?(e=Array.from(u),c()):e.slice()},d.rangeRound=function(u){return e=Array.from(u),r=pn,c()},d.clamp=function(u){return arguments.length?(a=u?!0:ar,c()):a!==ar},d.interpolate=function(u){return arguments.length?(r=u,c()):r},d.unknown=function(u){return arguments.length?(n=u,d):n},function(u,p){return i=u,o=p,c()}}function $r(){return ad()(ar,ar)}function zl(t){return Math.abs(t=Math.round(t))>=1e21?t.toLocaleString("en").replace(/,/g,""):t.toString(10)}function Ie(t,e){if((r=(t=e?t.toExponential(e-1):t.toExponential()).indexOf("e"))<0)return null;var r,i=t.slice(0,r);return[i.length>1?i[0]+i.slice(2):i,+t.slice(r+1)]}function Qt(t){return t=Ie(Math.abs(t)),t?t[1]:NaN}function ql(t,e){return function(r,i){for(var o=r.length,n=[],a=0,s=t[0],h=0;o>0&&s>0&&(h+s+1>i&&(s=Math.max(1,i-h)),n.push(r.substring(o-=s,o+s)),!((h+=s+1)>i));)s=t[a=(a+1)%t.length];return n.reverse().join(e)}}function Pl(t){return function(e){return e.replace(/[0-9]/g,function(r){return t[+r]})}}var sd=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function ye(t){if(!(e=sd.exec(t)))throw new Error("invalid format: "+t);var e;return new Hi({fill:e[1],align:e[2],sign:e[3],symbol:e[4],zero:e[5],width:e[6],comma:e[7],precision:e[8]&&e[8].slice(1),trim:e[9],type:e[10]})}ye.prototype=Hi.prototype;function Hi(t){this.fill=t.fill===void 0?" ":t.fill+"",this.align=t.align===void 0?">":t.align+"",this.sign=t.sign===void 0?"-":t.sign+"",this.symbol=t.symbol===void 0?"":t.symbol+"",this.zero=!!t.zero,this.width=t.width===void 0?void 0:+t.width,this.comma=!!t.comma,this.precision=t.precision===void 0?void 0:+t.precision,this.trim=!!t.trim,this.type=t.type===void 0?"":t.type+""}Hi.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function $l(t){t:for(var e=t.length,r=1,i=-1,o;r<e;++r)switch(t[r]){case".":i=o=r;break;case"0":i===0&&(i=r),o=r;break;default:if(!+t[r])break t;i>0&&(i=0);break}return i>0?t.slice(0,i)+t.slice(o+1):t}var Sn;function Wl(t,e){var r=Ie(t,e);if(!r)return t+"";var i=r[0],o=r[1],n=o-(Sn=Math.max(-8,Math.min(8,Math.floor(o/3)))*3)+1,a=i.length;return n===a?i:n>a?i+new Array(n-a+1).join("0"):n>0?i.slice(0,n)+"."+i.slice(n):"0."+new Array(1-n).join("0")+Ie(t,Math.max(0,e+n-1))[0]}function vn(t,e){var r=Ie(t,e);if(!r)return t+"";var i=r[0],o=r[1];return o<0?"0."+new Array(-o).join("0")+i:i.length>o+1?i.slice(0,o+1)+"."+i.slice(o+1):i+new Array(o-i.length+2).join("0")}var wn={"%":(t,e)=>(t*100).toFixed(e),b:t=>Math.round(t).toString(2),c:t=>t+"",d:zl,e:(t,e)=>t.toExponential(e),f:(t,e)=>t.toFixed(e),g:(t,e)=>t.toPrecision(e),o:t=>Math.round(t).toString(8),p:(t,e)=>vn(t*100,e),r:vn,s:Wl,X:t=>Math.round(t).toString(16).toUpperCase(),x:t=>Math.round(t).toString(16)};function Bn(t){return t}var Hl=Array.prototype.map,Ul=["y","z","a","f","p","n","\xB5","m","","k","M","G","T","P","E","Z","Y"];function Yl(t){var e=t.grouping===void 0||t.thousands===void 0?Bn:ql(Hl.call(t.grouping,Number),t.thousands+""),r=t.currency===void 0?"":t.currency[0]+"",i=t.currency===void 0?"":t.currency[1]+"",o=t.decimal===void 0?".":t.decimal+"",n=t.numerals===void 0?Bn:Pl(Hl.call(t.numerals,String)),a=t.percent===void 0?"%":t.percent+"",s=t.minus===void 0?"\u2212":t.minus+"",h=t.nan===void 0?"NaN":t.nan+"";function l(d){d=ye(d);var u=d.fill,p=d.align,T=d.sign,M=d.symbol,$=d.zero,q=d.width,G=d.comma,E=d.precision,F=d.trim,P=d.type;P==="n"?(G=!0,P="g"):wn[P]||(E===void 0&&(E=12),F=!0,P="g"),($||u==="0"&&p==="=")&&($=!0,u="0",p="=");var w=M==="$"?r:M==="#"&&/[boxX]/.test(P)?"0"+P.toLowerCase():"",X=M==="$"?i:/[%p]/.test(P)?a:"",j=wn[P],W=/[defgprs%]/.test(P);E=E===void 0?6:/[gprs]/.test(P)?Math.max(1,Math.min(21,E)):Math.max(0,Math.min(20,E));function rt(B){var k=w,g=X,x,L,S;if(P==="c")g=j(B)+g,B="";else{B=+B;var N=B<0||1/B<0;if(B=isNaN(B)?h:j(Math.abs(B),E),F&&(B=$l(B)),N&&+B==0&&T!=="+"&&(N=!1),k=(N?T==="("?T:s:T==="-"||T==="("?"":T)+k,g=(P==="s"?Ul[8+Sn/3]:"")+g+(N&&T==="("?")":""),W){for(x=-1,L=B.length;++x<L;)if(S=B.charCodeAt(x),48>S||S>57){g=(S===46?o+B.slice(x+1):B.slice(x))+g,B=B.slice(0,x);break}}}G&&!$&&(B=e(B,1/0));var O=k.length+B.length+g.length,U=O<q?new Array(q-O+1).join(u):"";switch(G&&$&&(B=e(U+B,U.length?q-g.length:1/0),U=""),p){case"<":B=k+B+g+U;break;case"=":B=k+U+B+g;break;case"^":B=U.slice(0,O=U.length>>1)+k+B+g+U.slice(O);break;default:B=U+k+B+g;break}return n(B)}return rt.toString=function(){return d+""},rt}function c(d,u){var p=l((d=ye(d),d.type="f",d)),T=Math.max(-8,Math.min(8,Math.floor(Qt(u)/3)))*3,M=Math.pow(10,-T),$=Ul[8+T/3];return function(q){return p(M*q)+$}}return{format:l,formatPrefix:c}}var Ui,Yi,Gi;Fn({thousands:",",grouping:[3],currency:["$",""]});function Fn(t){return Ui=Yl(t),Yi=Ui.format,Gi=Ui.formatPrefix,Ui}function Ln(t){return Math.max(0,-Qt(Math.abs(t)))}function Mn(t,e){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(Qt(e)/3)))*3-Qt(Math.abs(t)))}function An(t,e){return t=Math.abs(t),e=Math.abs(e)-t,Math.max(0,Qt(e)-Qt(t))+1}function En(t,e,r,i){var o=tr(t,e,r),n;switch(i=ye(i??",f"),i.type){case"s":{var a=Math.max(Math.abs(t),Math.abs(e));return i.precision==null&&!isNaN(n=Mn(o,a))&&(i.precision=n),Gi(i,a)}case"":case"e":case"g":case"p":case"r":{i.precision==null&&!isNaN(n=An(o,Math.max(Math.abs(t),Math.abs(e))))&&(i.precision=n-(i.type==="e"));break}case"f":case"%":{i.precision==null&&!isNaN(n=Ln(o))&&(i.precision=n-(i.type==="%")*2);break}}return Yi(i)}function ld(t){var e=t.domain;return t.ticks=function(r){var i=e();return wi(i[0],i[i.length-1],r??10)},t.tickFormat=function(r,i){var o=e();return En(o[0],o[o.length-1],r??10,i)},t.nice=function(r){r==null&&(r=10);var i=e(),o=0,n=i.length-1,a=i[o],s=i[n],h,l,c=10;for(s<a&&(l=a,a=s,s=l,l=o,o=n,n=l);c-- >0;){if(l=Er(a,s,r),l===h)return i[o]=a,i[n]=s,e(i);if(l>0)a=Math.floor(a/l)*l,s=Math.ceil(s/l)*l;else if(l<0)a=Math.ceil(a*l)/l,s=Math.floor(s*l)/l;else break;h=l}return t},t}function Dn(){var t=$r();return t.copy=function(){return Wi(t,Dn())},xe.apply(t,arguments),ld(t)}var On=new Date,In=new Date;function ot(t,e,r,i){function o(n){return t(n=arguments.length===0?new Date:new Date(+n)),n}return o.floor=n=>(t(n=new Date(+n)),n),o.ceil=n=>(t(n=new Date(n-1)),e(n,1),t(n),n),o.round=n=>{let a=o(n),s=o.ceil(n);return n-a<s-n?a:s},o.offset=(n,a)=>(e(n=new Date(+n),a==null?1:Math.floor(a)),n),o.range=(n,a,s)=>{let h=[];if(n=o.ceil(n),s=s==null?1:Math.floor(s),!(n<a)||!(s>0))return h;let l;do h.push(l=new Date(+n)),e(n,s),t(n);while(l<n&&n<a);return h},o.filter=n=>ot(a=>{if(a>=a)for(;t(a),!n(a);)a.setTime(a-1)},(a,s)=>{if(a>=a)if(s<0)for(;++s<=0;)for(;e(a,-1),!n(a););else for(;--s>=0;)for(;e(a,1),!n(a););}),r&&(o.count=(n,a)=>(On.setTime(+n),In.setTime(+a),t(On),t(In),Math.floor(r(On,In))),o.every=n=>(n=Math.floor(n),!isFinite(n)||!(n>0)?null:n>1?o.filter(i?a=>i(a)%n===0:a=>o.count(0,a)%n===0):o)),o}var Ne=ot(()=>{},(t,e)=>{t.setTime(+t+e)},(t,e)=>e-t);Ne.every=t=>(t=Math.floor(t),!isFinite(t)||!(t>0)?null:t>1?ot(e=>{e.setTime(Math.floor(e/t)*t)},(e,r)=>{e.setTime(+e+r*t)},(e,r)=>(r-e)/t):Ne);var Gl=Ne.range;var Jt=ot(t=>{t.setTime(t-t.getMilliseconds())},(t,e)=>{t.setTime(+t+e*1e3)},(t,e)=>(e-t)/1e3,t=>t.getUTCSeconds()),Vl=Jt.range;var sr=ot(t=>{t.setTime(t-t.getMilliseconds()-t.getSeconds()*1e3)},(t,e)=>{t.setTime(+t+e*6e4)},(t,e)=>(e-t)/6e4,t=>t.getMinutes()),hd=sr.range,Vi=ot(t=>{t.setUTCSeconds(0,0)},(t,e)=>{t.setTime(+t+e*6e4)},(t,e)=>(e-t)/6e4,t=>t.getUTCMinutes()),cd=Vi.range;var lr=ot(t=>{t.setTime(t-t.getMilliseconds()-t.getSeconds()*1e3-t.getMinutes()*6e4)},(t,e)=>{t.setTime(+t+e*36e5)},(t,e)=>(e-t)/36e5,t=>t.getHours()),ud=lr.range,Xi=ot(t=>{t.setUTCMinutes(0,0,0)},(t,e)=>{t.setTime(+t+e*36e5)},(t,e)=>(e-t)/36e5,t=>t.getUTCHours()),fd=Xi.range;var ce=ot(t=>t.setHours(0,0,0,0),(t,e)=>t.setDate(t.getDate()+e),(t,e)=>(e-t-(e.getTimezoneOffset()-t.getTimezoneOffset())*6e4)/864e5,t=>t.getDate()-1),md=ce.range,Hr=ot(t=>{t.setUTCHours(0,0,0,0)},(t,e)=>{t.setUTCDate(t.getUTCDate()+e)},(t,e)=>(e-t)/864e5,t=>t.getUTCDate()-1),dd=Hr.range,ji=ot(t=>{t.setUTCHours(0,0,0,0)},(t,e)=>{t.setUTCDate(t.getUTCDate()+e)},(t,e)=>(e-t)/864e5,t=>Math.floor(t/864e5)),pd=ji.range;function qe(t){return ot(e=>{e.setDate(e.getDate()-(e.getDay()+7-t)%7),e.setHours(0,0,0,0)},(e,r)=>{e.setDate(e.getDate()+r*7)},(e,r)=>(r-e-(r.getTimezoneOffset()-e.getTimezoneOffset())*6e4)/6048e5)}var ue=qe(0),hr=qe(1),jl=qe(2),Zl=qe(3),Ce=qe(4),Kl=qe(5),Ql=qe(6),Jl=ue.range,gd=hr.range,xd=jl.range,yd=Zl.range,Cd=Ce.range,_d=Kl.range,bd=Ql.range;function Pe(t){return ot(e=>{e.setUTCDate(e.getUTCDate()-(e.getUTCDay()+7-t)%7),e.setUTCHours(0,0,0,0)},(e,r)=>{e.setUTCDate(e.getUTCDate()+r*7)},(e,r)=>(r-e)/6048e5)}var $e=Pe(0),cr=Pe(1),th=Pe(2),eh=Pe(3),_e=Pe(4),rh=Pe(5),ih=Pe(6),oh=$e.range,Td=cr.range,kd=th.range,Sd=eh.range,vd=_e.range,wd=rh.range,Bd=ih.range;var ur=ot(t=>{t.setDate(1),t.setHours(0,0,0,0)},(t,e)=>{t.setMonth(t.getMonth()+e)},(t,e)=>e.getMonth()-t.getMonth()+(e.getFullYear()-t.getFullYear())*12,t=>t.getMonth()),Fd=ur.range,Zi=ot(t=>{t.setUTCDate(1),t.setUTCHours(0,0,0,0)},(t,e)=>{t.setUTCMonth(t.getUTCMonth()+e)},(t,e)=>e.getUTCMonth()-t.getUTCMonth()+(e.getUTCFullYear()-t.getUTCFullYear())*12,t=>t.getUTCMonth()),Ld=Zi.range;var zt=ot(t=>{t.setMonth(0,1),t.setHours(0,0,0,0)},(t,e)=>{t.setFullYear(t.getFullYear()+e)},(t,e)=>e.getFullYear()-t.getFullYear(),t=>t.getFullYear());zt.every=t=>!isFinite(t=Math.floor(t))||!(t>0)?null:ot(e=>{e.setFullYear(Math.floor(e.getFullYear()/t)*t),e.setMonth(0,1),e.setHours(0,0,0,0)},(e,r)=>{e.setFullYear(e.getFullYear()+r*t)});var Md=zt.range,Gt=ot(t=>{t.setUTCMonth(0,1),t.setUTCHours(0,0,0,0)},(t,e)=>{t.setUTCFullYear(t.getUTCFullYear()+e)},(t,e)=>e.getUTCFullYear()-t.getUTCFullYear(),t=>t.getUTCFullYear());Gt.every=t=>!isFinite(t=Math.floor(t))||!(t>0)?null:ot(e=>{e.setUTCFullYear(Math.floor(e.getUTCFullYear()/t)*t),e.setUTCMonth(0,1),e.setUTCHours(0,0,0,0)},(e,r)=>{e.setUTCFullYear(e.getUTCFullYear()+r*t)});var Ad=Gt.range;function ah(t,e,r,i,o,n){let a=[[Jt,1,1e3],[Jt,5,5*1e3],[Jt,15,15*1e3],[Jt,30,30*1e3],[n,1,6e4],[n,5,5*6e4],[n,15,15*6e4],[n,30,30*6e4],[o,1,36e5],[o,3,3*36e5],[o,6,6*36e5],[o,12,12*36e5],[i,1,864e5],[i,2,2*864e5],[r,1,6048e5],[e,1,2592e6],[e,3,3*2592e6],[t,1,31536e6]];function s(l,c,d){let u=c<l;u&&([l,c]=[c,l]);let p=d&&typeof d.range=="function"?d:h(l,c,d),T=p?p.range(l,+c+1):[];return u?T.reverse():T}function h(l,c,d){let u=Math.abs(c-l)/d,p=Fe(([,,$])=>$).right(a,u);if(p===a.length)return t.every(tr(l/31536e6,c/31536e6,d));if(p===0)return Ne.every(Math.max(tr(l,c,d),1));let[T,M]=a[u/a[p-1][2]<a[p][2]/u?p-1:p];return T.every(M)}return[s,h]}var[Dd,Od]=ah(Gt,Zi,$e,ji,Xi,Vi),[Nn,Rn]=ah(zt,ur,ue,ce,lr,sr);function zn(t){if(0<=t.y&&t.y<100){var e=new Date(-1,t.m,t.d,t.H,t.M,t.S,t.L);return e.setFullYear(t.y),e}return new Date(t.y,t.m,t.d,t.H,t.M,t.S,t.L)}function qn(t){if(0<=t.y&&t.y<100){var e=new Date(Date.UTC(-1,t.m,t.d,t.H,t.M,t.S,t.L));return e.setUTCFullYear(t.y),e}return new Date(Date.UTC(t.y,t.m,t.d,t.H,t.M,t.S,t.L))}function Ur(t,e,r){return{y:t,m:e,d:r,H:0,M:0,S:0,L:0}}function Pn(t){var e=t.dateTime,r=t.date,i=t.time,o=t.periods,n=t.days,a=t.shortDays,s=t.months,h=t.shortMonths,l=Yr(o),c=Gr(o),d=Yr(n),u=Gr(n),p=Yr(a),T=Gr(a),M=Yr(s),$=Gr(s),q=Yr(h),G=Gr(h),E={a:N,A:O,b:U,B:et,c:null,d:fh,e:fh,f:ip,g:mp,G:pp,H:tp,I:ep,j:rp,L:xh,m:op,M:np,p:Y,q:nt,Q:ph,s:gh,S:ap,u:sp,U:lp,V:hp,w:cp,W:up,x:null,X:null,y:fp,Y:dp,Z:gp,"%":dh},F={a:Q,A:Bt,b:Z,B:xt,c:null,d:mh,e:mh,f:_p,g:Mp,G:Ep,H:xp,I:yp,j:Cp,L:Ch,m:bp,M:Tp,p:yt,q:lt,Q:ph,s:gh,S:kp,u:Sp,U:vp,V:wp,w:Bp,W:Fp,x:null,X:null,y:Lp,Y:Ap,Z:Dp,"%":dh},P={a:rt,A:B,b:k,B:g,c:x,d:ch,e:ch,f:Zd,g:hh,G:lh,H:uh,I:uh,j:Gd,L:jd,m:Yd,M:Vd,p:W,q:Ud,Q:Qd,s:Jd,S:Xd,u:qd,U:Pd,V:$d,w:zd,W:Wd,x:L,X:S,y:hh,Y:lh,Z:Hd,"%":Kd};E.x=w(r,E),E.X=w(i,E),E.c=w(e,E),F.x=w(r,F),F.X=w(i,F),F.c=w(e,F);function w(v,H){return function(V){var C=[],mt=-1,J=0,Ct=v.length,_t,Ot,Se;for(V instanceof Date||(V=new Date(+V));++mt<Ct;)v.charCodeAt(mt)===37&&(C.push(v.slice(J,mt)),(Ot=sh[_t=v.charAt(++mt)])!=null?_t=v.charAt(++mt):Ot=_t==="e"?" ":"0",(Se=H[_t])&&(_t=Se(V,Ot)),C.push(_t),J=mt+1);return C.push(v.slice(J,mt)),C.join("")}}function X(v,H){return function(V){var C=Ur(1900,void 0,1),mt=j(C,v,V+="",0),J,Ct;if(mt!=V.length)return null;if("Q"in C)return new Date(C.Q);if("s"in C)return new Date(C.s*1e3+("L"in C?C.L:0));if(H&&!("Z"in C)&&(C.Z=0),"p"in C&&(C.H=C.H%12+C.p*12),C.m===void 0&&(C.m="q"in C?C.q:0),"V"in C){if(C.V<1||C.V>53)return null;"w"in C||(C.w=1),"Z"in C?(J=qn(Ur(C.y,0,1)),Ct=J.getUTCDay(),J=Ct>4||Ct===0?cr.ceil(J):cr(J),J=Hr.offset(J,(C.V-1)*7),C.y=J.getUTCFullYear(),C.m=J.getUTCMonth(),C.d=J.getUTCDate()+(C.w+6)%7):(J=zn(Ur(C.y,0,1)),Ct=J.getDay(),J=Ct>4||Ct===0?hr.ceil(J):hr(J),J=ce.offset(J,(C.V-1)*7),C.y=J.getFullYear(),C.m=J.getMonth(),C.d=J.getDate()+(C.w+6)%7)}else("W"in C||"U"in C)&&("w"in C||(C.w="u"in C?C.u%7:"W"in C?1:0),Ct="Z"in C?qn(Ur(C.y,0,1)).getUTCDay():zn(Ur(C.y,0,1)).getDay(),C.m=0,C.d="W"in C?(C.w+6)%7+C.W*7-(Ct+5)%7:C.w+C.U*7-(Ct+6)%7);return"Z"in C?(C.H+=C.Z/100|0,C.M+=C.Z%100,qn(C)):zn(C)}}function j(v,H,V,C){for(var mt=0,J=H.length,Ct=V.length,_t,Ot;mt<J;){if(C>=Ct)return-1;if(_t=H.charCodeAt(mt++),_t===37){if(_t=H.charAt(mt++),Ot=P[_t in sh?H.charAt(mt++):_t],!Ot||(C=Ot(v,V,C))<0)return-1}else if(_t!=V.charCodeAt(C++))return-1}return C}function W(v,H,V){var C=l.exec(H.slice(V));return C?(v.p=c.get(C[0].toLowerCase()),V+C[0].length):-1}function rt(v,H,V){var C=p.exec(H.slice(V));return C?(v.w=T.get(C[0].toLowerCase()),V+C[0].length):-1}function B(v,H,V){var C=d.exec(H.slice(V));return C?(v.w=u.get(C[0].toLowerCase()),V+C[0].length):-1}function k(v,H,V){var C=q.exec(H.slice(V));return C?(v.m=G.get(C[0].toLowerCase()),V+C[0].length):-1}function g(v,H,V){var C=M.exec(H.slice(V));return C?(v.m=$.get(C[0].toLowerCase()),V+C[0].length):-1}function x(v,H,V){return j(v,e,H,V)}function L(v,H,V){return j(v,r,H,V)}function S(v,H,V){return j(v,i,H,V)}function N(v){return a[v.getDay()]}function O(v){return n[v.getDay()]}function U(v){return h[v.getMonth()]}function et(v){return s[v.getMonth()]}function Y(v){return o[+(v.getHours()>=12)]}function nt(v){return 1+~~(v.getMonth()/3)}function Q(v){return a[v.getUTCDay()]}function Bt(v){return n[v.getUTCDay()]}function Z(v){return h[v.getUTCMonth()]}function xt(v){return s[v.getUTCMonth()]}function yt(v){return o[+(v.getUTCHours()>=12)]}function lt(v){return 1+~~(v.getUTCMonth()/3)}return{format:function(v){var H=w(v+="",E);return H.toString=function(){return v},H},parse:function(v){var H=X(v+="",!1);return H.toString=function(){return v},H},utcFormat:function(v){var H=w(v+="",F);return H.toString=function(){return v},H},utcParse:function(v){var H=X(v+="",!0);return H.toString=function(){return v},H}}}var sh={"-":"",_:" ",0:"0"},pt=/^\s*\d+/,Id=/^%/,Nd=/[\\^$*+?|[\]().{}]/g;function tt(t,e,r){var i=t<0?"-":"",o=(i?-t:t)+"",n=o.length;return i+(n<r?new Array(r-n+1).join(e)+o:o)}function Rd(t){return t.replace(Nd,"\\$&")}function Yr(t){return new RegExp("^(?:"+t.map(Rd).join("|")+")","i")}function Gr(t){return new Map(t.map((e,r)=>[e.toLowerCase(),r]))}function zd(t,e,r){var i=pt.exec(e.slice(r,r+1));return i?(t.w=+i[0],r+i[0].length):-1}function qd(t,e,r){var i=pt.exec(e.slice(r,r+1));return i?(t.u=+i[0],r+i[0].length):-1}function Pd(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.U=+i[0],r+i[0].length):-1}function $d(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.V=+i[0],r+i[0].length):-1}function Wd(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.W=+i[0],r+i[0].length):-1}function lh(t,e,r){var i=pt.exec(e.slice(r,r+4));return i?(t.y=+i[0],r+i[0].length):-1}function hh(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.y=+i[0]+(+i[0]>68?1900:2e3),r+i[0].length):-1}function Hd(t,e,r){var i=/^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(e.slice(r,r+6));return i?(t.Z=i[1]?0:-(i[2]+(i[3]||"00")),r+i[0].length):-1}function Ud(t,e,r){var i=pt.exec(e.slice(r,r+1));return i?(t.q=i[0]*3-3,r+i[0].length):-1}function Yd(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.m=i[0]-1,r+i[0].length):-1}function ch(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.d=+i[0],r+i[0].length):-1}function Gd(t,e,r){var i=pt.exec(e.slice(r,r+3));return i?(t.m=0,t.d=+i[0],r+i[0].length):-1}function uh(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.H=+i[0],r+i[0].length):-1}function Vd(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.M=+i[0],r+i[0].length):-1}function Xd(t,e,r){var i=pt.exec(e.slice(r,r+2));return i?(t.S=+i[0],r+i[0].length):-1}function jd(t,e,r){var i=pt.exec(e.slice(r,r+3));return i?(t.L=+i[0],r+i[0].length):-1}function Zd(t,e,r){var i=pt.exec(e.slice(r,r+6));return i?(t.L=Math.floor(i[0]/1e3),r+i[0].length):-1}function Kd(t,e,r){var i=Id.exec(e.slice(r,r+1));return i?r+i[0].length:-1}function Qd(t,e,r){var i=pt.exec(e.slice(r));return i?(t.Q=+i[0],r+i[0].length):-1}function Jd(t,e,r){var i=pt.exec(e.slice(r));return i?(t.s=+i[0],r+i[0].length):-1}function fh(t,e){return tt(t.getDate(),e,2)}function tp(t,e){return tt(t.getHours(),e,2)}function ep(t,e){return tt(t.getHours()%12||12,e,2)}function rp(t,e){return tt(1+ce.count(zt(t),t),e,3)}function xh(t,e){return tt(t.getMilliseconds(),e,3)}function ip(t,e){return xh(t,e)+"000"}function op(t,e){return tt(t.getMonth()+1,e,2)}function np(t,e){return tt(t.getMinutes(),e,2)}function ap(t,e){return tt(t.getSeconds(),e,2)}function sp(t){var e=t.getDay();return e===0?7:e}function lp(t,e){return tt(ue.count(zt(t)-1,t),e,2)}function yh(t){var e=t.getDay();return e>=4||e===0?Ce(t):Ce.ceil(t)}function hp(t,e){return t=yh(t),tt(Ce.count(zt(t),t)+(zt(t).getDay()===4),e,2)}function cp(t){return t.getDay()}function up(t,e){return tt(hr.count(zt(t)-1,t),e,2)}function fp(t,e){return tt(t.getFullYear()%100,e,2)}function mp(t,e){return t=yh(t),tt(t.getFullYear()%100,e,2)}function dp(t,e){return tt(t.getFullYear()%1e4,e,4)}function pp(t,e){var r=t.getDay();return t=r>=4||r===0?Ce(t):Ce.ceil(t),tt(t.getFullYear()%1e4,e,4)}function gp(t){var e=t.getTimezoneOffset();return(e>0?"-":(e*=-1,"+"))+tt(e/60|0,"0",2)+tt(e%60,"0",2)}function mh(t,e){return tt(t.getUTCDate(),e,2)}function xp(t,e){return tt(t.getUTCHours(),e,2)}function yp(t,e){return tt(t.getUTCHours()%12||12,e,2)}function Cp(t,e){return tt(1+Hr.count(Gt(t),t),e,3)}function Ch(t,e){return tt(t.getUTCMilliseconds(),e,3)}function _p(t,e){return Ch(t,e)+"000"}function bp(t,e){return tt(t.getUTCMonth()+1,e,2)}function Tp(t,e){return tt(t.getUTCMinutes(),e,2)}function kp(t,e){return tt(t.getUTCSeconds(),e,2)}function Sp(t){var e=t.getUTCDay();return e===0?7:e}function vp(t,e){return tt($e.count(Gt(t)-1,t),e,2)}function _h(t){var e=t.getUTCDay();return e>=4||e===0?_e(t):_e.ceil(t)}function wp(t,e){return t=_h(t),tt(_e.count(Gt(t),t)+(Gt(t).getUTCDay()===4),e,2)}function Bp(t){return t.getUTCDay()}function Fp(t,e){return tt(cr.count(Gt(t)-1,t),e,2)}function Lp(t,e){return tt(t.getUTCFullYear()%100,e,2)}function Mp(t,e){return t=_h(t),tt(t.getUTCFullYear()%100,e,2)}function Ap(t,e){return tt(t.getUTCFullYear()%1e4,e,4)}function Ep(t,e){var r=t.getUTCDay();return t=r>=4||r===0?_e(t):_e.ceil(t),tt(t.getUTCFullYear()%1e4,e,4)}function Dp(){return"+0000"}function dh(){return"%"}function ph(t){return+t}function gh(t){return Math.floor(+t/1e3)}var fr,Ki,bh,Th,kh;$n({dateTime:"%x, %X",date:"%-m/%-d/%Y",time:"%-I:%M:%S %p",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]});function $n(t){return fr=Pn(t),Ki=fr.format,bh=fr.parse,Th=fr.utcFormat,kh=fr.utcParse,fr}function Wn(t,e){t=t.slice();var r=0,i=t.length-1,o=t[r],n=t[i],a;return n<o&&(a=r,r=i,i=a,a=o,o=n,n=a),t[r]=e.floor(o),t[i]=e.ceil(n),t}function Op(t){return new Date(t)}function Ip(t){return t instanceof Date?+t:+new Date(+t)}function Sh(t,e,r,i,o,n,a,s,h,l){var c=$r(),d=c.invert,u=c.domain,p=l(".%L"),T=l(":%S"),M=l("%I:%M"),$=l("%I %p"),q=l("%a %d"),G=l("%b %d"),E=l("%B"),F=l("%Y");function P(w){return(h(w)<w?p:s(w)<w?T:a(w)<w?M:n(w)<w?$:i(w)<w?o(w)<w?q:G:r(w)<w?E:F)(w)}return c.invert=function(w){return new Date(d(w))},c.domain=function(w){return arguments.length?u(Array.from(w,Ip)):u().map(Op)},c.ticks=function(w){var X=u();return t(X[0],X[X.length-1],w??10)},c.tickFormat=function(w,X){return X==null?P:l(X)},c.nice=function(w){var X=u();return(!w||typeof w.range!="function")&&(w=e(X[0],X[X.length-1],w??10)),w?u(Wn(X,w)):c},c.copy=function(){return Wi(c,Sh(t,e,r,i,o,n,a,s,h,l))},c}function vh(){return xe.apply(Sh(Nn,Rn,zt,ur,ue,ce,lr,sr,Jt,Ki).domain([new Date(2e3,0,1),new Date(2e3,0,2)]),arguments)}function wh(t){for(var e=t.length/6|0,r=new Array(e),i=0;i<e;)r[i]="#"+t.slice(i*6,++i*6);return r}var Np=wh("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");function st(t){return function(){return t}}var Hn=Math.abs,St=Math.atan2,be=Math.cos,Bh=Math.max,Qi=Math.min,Vt=Math.sin,We=Math.sqrt,gt=1e-12,mr=Math.PI,Vr=mr/2,dr=2*mr;function Fh(t){return t>1?0:t<-1?mr:Math.acos(t)}function Un(t){return t>=1?Vr:t<=-1?-Vr:Math.asin(t)}var Yn=Math.PI,Gn=2*Yn,He=1e-6,Rp=Gn-He;function Lh(t){this._+=t[0];for(let e=1,r=t.length;e<r;++e)this._+=arguments[e]+t[e]}function zp(t){let e=Math.floor(t);if(!(e>=0))throw new Error(`invalid digits: ${t}`);if(e>15)return Lh;let r=10**e;return function(i){this._+=i[0];for(let o=1,n=i.length;o<n;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}var Ue=class{constructor(e){this._x0=this._y0=this._x1=this._y1=null,this._="",this._append=e==null?Lh:zp(e)}moveTo(e,r){this._append`M${this._x0=this._x1=+e},${this._y0=this._y1=+r}`}closePath(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._append`Z`)}lineTo(e,r){this._append`L${this._x1=+e},${this._y1=+r}`}quadraticCurveTo(e,r,i,o){this._append`Q${+e},${+r},${this._x1=+i},${this._y1=+o}`}bezierCurveTo(e,r,i,o,n,a){this._append`C${+e},${+r},${+i},${+o},${this._x1=+n},${this._y1=+a}`}arcTo(e,r,i,o,n){if(e=+e,r=+r,i=+i,o=+o,n=+n,n<0)throw new Error(`negative radius: ${n}`);let a=this._x1,s=this._y1,h=i-e,l=o-r,c=a-e,d=s-r,u=c*c+d*d;if(this._x1===null)this._append`M${this._x1=e},${this._y1=r}`;else if(u>He)if(!(Math.abs(d*h-l*c)>He)||!n)this._append`L${this._x1=e},${this._y1=r}`;else{let p=i-a,T=o-s,M=h*h+l*l,$=p*p+T*T,q=Math.sqrt(M),G=Math.sqrt(u),E=n*Math.tan((Yn-Math.acos((M+u-$)/(2*q*G)))/2),F=E/G,P=E/q;Math.abs(F-1)>He&&this._append`L${e+F*c},${r+F*d}`,this._append`A${n},${n},0,0,${+(d*p>c*T)},${this._x1=e+P*h},${this._y1=r+P*l}`}}arc(e,r,i,o,n,a){if(e=+e,r=+r,i=+i,a=!!a,i<0)throw new Error(`negative radius: ${i}`);let s=i*Math.cos(o),h=i*Math.sin(o),l=e+s,c=r+h,d=1^a,u=a?o-n:n-o;this._x1===null?this._append`M${l},${c}`:(Math.abs(this._x1-l)>He||Math.abs(this._y1-c)>He)&&this._append`L${l},${c}`,i&&(u<0&&(u=u%Gn+Gn),u>Rp?this._append`A${i},${i},0,1,${d},${e-s},${r-h}A${i},${i},0,1,${d},${this._x1=l},${this._y1=c}`:u>He&&this._append`A${i},${i},0,${+(u>=Yn)},${d},${this._x1=e+i*Math.cos(n)},${this._y1=r+i*Math.sin(n)}`)}rect(e,r,i,o){this._append`M${this._x0=this._x1=+e},${this._y0=this._y1=+r}h${i=+i}v${+o}h${-i}Z`}toString(){return this._}};function Mh(){return new Ue}Mh.prototype=Ue.prototype;function Ji(t){let e=3;return t.digits=function(r){if(!arguments.length)return e;if(r==null)e=null;else{let i=Math.floor(r);if(!(i>=0))throw new RangeError(`invalid digits: ${r}`);e=i}return t},()=>new Ue(e)}function qp(t){return t.innerRadius}function Pp(t){return t.outerRadius}function $p(t){return t.startAngle}function Wp(t){return t.endAngle}function Hp(t){return t&&t.padAngle}function Up(t,e,r,i,o,n,a,s){var h=r-t,l=i-e,c=a-o,d=s-n,u=d*h-c*l;if(!(u*u<gt))return u=(c*(e-n)-d*(t-o))/u,[t+u*h,e+u*l]}function to(t,e,r,i,o,n,a){var s=t-r,h=e-i,l=(a?n:-n)/We(s*s+h*h),c=l*h,d=-l*s,u=t+c,p=e+d,T=r+c,M=i+d,$=(u+T)/2,q=(p+M)/2,G=T-u,E=M-p,F=G*G+E*E,P=o-n,w=u*M-T*p,X=(E<0?-1:1)*We(Bh(0,P*P*F-w*w)),j=(w*E-G*X)/F,W=(-w*G-E*X)/F,rt=(w*E+G*X)/F,B=(-w*G+E*X)/F,k=j-$,g=W-q,x=rt-$,L=B-q;return k*k+g*g>x*x+L*L&&(j=rt,W=B),{cx:j,cy:W,x01:-c,y01:-d,x11:j*(o/P-1),y11:W*(o/P-1)}}function Yp(){var t=qp,e=Pp,r=st(0),i=null,o=$p,n=Wp,a=Hp,s=null,h=Ji(l);function l(){var c,d,u=+t.apply(this,arguments),p=+e.apply(this,arguments),T=o.apply(this,arguments)-Vr,M=n.apply(this,arguments)-Vr,$=Hn(M-T),q=M>T;if(s||(s=c=h()),p<u&&(d=p,p=u,u=d),!(p>gt))s.moveTo(0,0);else if($>dr-gt)s.moveTo(p*be(T),p*Vt(T)),s.arc(0,0,p,T,M,!q),u>gt&&(s.moveTo(u*be(M),u*Vt(M)),s.arc(0,0,u,M,T,q));else{var G=T,E=M,F=T,P=M,w=$,X=$,j=a.apply(this,arguments)/2,W=j>gt&&(i?+i.apply(this,arguments):We(u*u+p*p)),rt=Qi(Hn(p-u)/2,+r.apply(this,arguments)),B=rt,k=rt,g,x;if(W>gt){var L=Un(W/u*Vt(j)),S=Un(W/p*Vt(j));(w-=L*2)>gt?(L*=q?1:-1,F+=L,P-=L):(w=0,F=P=(T+M)/2),(X-=S*2)>gt?(S*=q?1:-1,G+=S,E-=S):(X=0,G=E=(T+M)/2)}var N=p*be(G),O=p*Vt(G),U=u*be(P),et=u*Vt(P);if(rt>gt){var Y=p*be(E),nt=p*Vt(E),Q=u*be(F),Bt=u*Vt(F),Z;if($<mr)if(Z=Up(N,O,Q,Bt,Y,nt,U,et)){var xt=N-Z[0],yt=O-Z[1],lt=Y-Z[0],v=nt-Z[1],H=1/Vt(Fh((xt*lt+yt*v)/(We(xt*xt+yt*yt)*We(lt*lt+v*v)))/2),V=We(Z[0]*Z[0]+Z[1]*Z[1]);B=Qi(rt,(u-V)/(H-1)),k=Qi(rt,(p-V)/(H+1))}else B=k=0}X>gt?k>gt?(g=to(Q,Bt,N,O,p,k,q),x=to(Y,nt,U,et,p,k,q),s.moveTo(g.cx+g.x01,g.cy+g.y01),k<rt?s.arc(g.cx,g.cy,k,St(g.y01,g.x01),St(x.y01,x.x01),!q):(s.arc(g.cx,g.cy,k,St(g.y01,g.x01),St(g.y11,g.x11),!q),s.arc(0,0,p,St(g.cy+g.y11,g.cx+g.x11),St(x.cy+x.y11,x.cx+x.x11),!q),s.arc(x.cx,x.cy,k,St(x.y11,x.x11),St(x.y01,x.x01),!q))):(s.moveTo(N,O),s.arc(0,0,p,G,E,!q)):s.moveTo(N,O),!(u>gt)||!(w>gt)?s.lineTo(U,et):B>gt?(g=to(U,et,Y,nt,u,-B,q),x=to(N,O,Q,Bt,u,-B,q),s.lineTo(g.cx+g.x01,g.cy+g.y01),B<rt?s.arc(g.cx,g.cy,B,St(g.y01,g.x01),St(x.y01,x.x01),!q):(s.arc(g.cx,g.cy,B,St(g.y01,g.x01),St(g.y11,g.x11),!q),s.arc(0,0,u,St(g.cy+g.y11,g.cx+g.x11),St(x.cy+x.y11,x.cx+x.x11),q),s.arc(x.cx,x.cy,B,St(x.y11,x.x11),St(x.y01,x.x01),!q))):s.arc(0,0,u,P,F,q)}if(s.closePath(),c)return s=null,c+""||null}return l.centroid=function(){var c=(+t.apply(this,arguments)+ +e.apply(this,arguments))/2,d=(+o.apply(this,arguments)+ +n.apply(this,arguments))/2-mr/2;return[be(d)*c,Vt(d)*c]},l.innerRadius=function(c){return arguments.length?(t=typeof c=="function"?c:st(+c),l):t},l.outerRadius=function(c){return arguments.length?(e=typeof c=="function"?c:st(+c),l):e},l.cornerRadius=function(c){return arguments.length?(r=typeof c=="function"?c:st(+c),l):r},l.padRadius=function(c){return arguments.length?(i=c==null?null:typeof c=="function"?c:st(+c),l):i},l.startAngle=function(c){return arguments.length?(o=typeof c=="function"?c:st(+c),l):o},l.endAngle=function(c){return arguments.length?(n=typeof c=="function"?c:st(+c),l):n},l.padAngle=function(c){return arguments.length?(a=typeof c=="function"?c:st(+c),l):a},l.context=function(c){return arguments.length?(s=c??null,l):s},l}var Sk=Array.prototype.slice;function eo(t){return typeof t=="object"&&"length"in t?t:Array.from(t)}function Ah(t){this._context=t}Ah.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;default:this._context.lineTo(t,e);break}}};function Vn(t){return new Ah(t)}function Eh(t){return t[0]}function Dh(t){return t[1]}function Gp(t,e){var r=st(!0),i=null,o=Vn,n=null,a=Ji(s);t=typeof t=="function"?t:t===void 0?Eh:st(t),e=typeof e=="function"?e:e===void 0?Dh:st(e);function s(h){var l,c=(h=eo(h)).length,d,u=!1,p;for(i==null&&(n=o(p=a())),l=0;l<=c;++l)!(l<c&&r(d=h[l],l,h))===u&&((u=!u)?n.lineStart():n.lineEnd()),u&&n.point(+t(d,l,h),+e(d,l,h));if(p)return n=null,p+""||null}return s.x=function(h){return arguments.length?(t=typeof h=="function"?h:st(+h),s):t},s.y=function(h){return arguments.length?(e=typeof h=="function"?h:st(+h),s):e},s.defined=function(h){return arguments.length?(r=typeof h=="function"?h:st(!!h),s):r},s.curve=function(h){return arguments.length?(o=h,i!=null&&(n=o(i)),s):o},s.context=function(h){return arguments.length?(h==null?i=n=null:n=o(i=h),s):i},s}function Oh(t,e){return e<t?-1:e>t?1:e>=t?0:NaN}function Ih(t){return t}function Vp(){var t=Ih,e=Oh,r=null,i=st(0),o=st(dr),n=st(0);function a(s){var h,l=(s=eo(s)).length,c,d,u=0,p=new Array(l),T=new Array(l),M=+i.apply(this,arguments),$=Math.min(dr,Math.max(-dr,o.apply(this,arguments)-M)),q,G=Math.min(Math.abs($)/l,n.apply(this,arguments)),E=G*($<0?-1:1),F;for(h=0;h<l;++h)(F=T[p[h]=h]=+t(s[h],h,s))>0&&(u+=F);for(e!=null?p.sort(function(P,w){return e(T[P],T[w])}):r!=null&&p.sort(function(P,w){return r(s[P],s[w])}),h=0,d=u?($-l*E)/u:0;h<l;++h,M=q)c=p[h],F=T[c],q=M+(F>0?F*d:0)+E,T[c]={data:s[c],index:h,value:F,startAngle:M,endAngle:q,padAngle:G};return T}return a.value=function(s){return arguments.length?(t=typeof s=="function"?s:st(+s),a):t},a.sortValues=function(s){return arguments.length?(e=s,r=null,a):e},a.sort=function(s){return arguments.length?(r=s,e=null,a):r},a.startAngle=function(s){return arguments.length?(i=typeof s=="function"?s:st(+s),a):i},a.endAngle=function(s){return arguments.length?(o=typeof s=="function"?s:st(+s),a):o},a.padAngle=function(s){return arguments.length?(n=typeof s=="function"?s:st(+s),a):n},a}function pr(t,e,r){t._context.bezierCurveTo((2*t._x0+t._x1)/3,(2*t._y0+t._y1)/3,(t._x0+2*t._x1)/3,(t._y0+2*t._y1)/3,(t._x0+4*t._x1+e)/6,(t._y0+4*t._y1+r)/6)}function Xr(t){this._context=t}Xr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){switch(this._point){case 3:pr(this,this._x1,this._y1);case 2:this._context.lineTo(this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:pr(this,t,e);break}this._x0=this._x1,this._x1=t,this._y0=this._y1,this._y1=e}};function Xp(t){return new Xr(t)}var ro=class{constructor(e,r){this._context=e,this._x=r}areaStart(){this._line=0}areaEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line}point(e,r){switch(e=+e,r=+r,this._point){case 0:{this._point=1,this._line?this._context.lineTo(e,r):this._context.moveTo(e,r);break}case 1:this._point=2;default:{this._x?this._context.bezierCurveTo(this._x0=(this._x0+e)/2,this._y0,this._x0,r,e,r):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+r)/2,e,this._y0,e,r);break}}this._x0=e,this._y0=r}};function jp(t){return new ro(t,!0)}function Zp(t){return new ro(t,!1)}function $t(){}function Nh(t){this._context=t}Nh.prototype={areaStart:$t,areaEnd:$t,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._y0=this._y1=this._y2=this._y3=this._y4=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x2,this._y2),this._context.closePath();break}case 2:{this._context.moveTo((this._x2+2*this._x3)/3,(this._y2+2*this._y3)/3),this._context.lineTo((this._x3+2*this._x2)/3,(this._y3+2*this._y2)/3),this._context.closePath();break}case 3:{this.point(this._x2,this._y2),this.point(this._x3,this._y3),this.point(this._x4,this._y4);break}}},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._x2=t,this._y2=e;break;case 1:this._point=2,this._x3=t,this._y3=e;break;case 2:this._point=3,this._x4=t,this._y4=e,this._context.moveTo((this._x0+4*this._x1+t)/6,(this._y0+4*this._y1+e)/6);break;default:pr(this,t,e);break}this._x0=this._x1,this._x1=t,this._y0=this._y1,this._y1=e}};function Kp(t){return new Nh(t)}function Rh(t){this._context=t}Rh.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var r=(this._x0+4*this._x1+t)/6,i=(this._y0+4*this._y1+e)/6;this._line?this._context.lineTo(r,i):this._context.moveTo(r,i);break;case 3:this._point=4;default:pr(this,t,e);break}this._x0=this._x1,this._x1=t,this._y0=this._y1,this._y1=e}};function Qp(t){return new Rh(t)}function zh(t,e){this._basis=new Xr(t),this._beta=e}zh.prototype={lineStart:function(){this._x=[],this._y=[],this._basis.lineStart()},lineEnd:function(){var t=this._x,e=this._y,r=t.length-1;if(r>0)for(var i=t[0],o=e[0],n=t[r]-i,a=e[r]-o,s=-1,h;++s<=r;)h=s/r,this._basis.point(this._beta*t[s]+(1-this._beta)*(i+h*n),this._beta*e[s]+(1-this._beta)*(o+h*a));this._x=this._y=null,this._basis.lineEnd()},point:function(t,e){this._x.push(+t),this._y.push(+e)}};var Jp=function t(e){function r(i){return e===1?new Xr(i):new zh(i,e)}return r.beta=function(i){return t(+i)},r}(.85);function gr(t,e,r){t._context.bezierCurveTo(t._x1+t._k*(t._x2-t._x0),t._y1+t._k*(t._y2-t._y0),t._x2+t._k*(t._x1-e),t._y2+t._k*(t._y1-r),t._x2,t._y2)}function io(t,e){this._context=t,this._k=(1-e)/6}io.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:gr(this,this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2,this._x1=t,this._y1=e;break;case 2:this._point=3;default:gr(this,t,e);break}this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var tg=function t(e){function r(i){return new io(i,e)}return r.tension=function(i){return t(+i)},r}(0);function oo(t,e){this._context=t,this._k=(1-e)/6}oo.prototype={areaStart:$t,areaEnd:$t,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._x3=t,this._y3=e;break;case 1:this._point=2,this._context.moveTo(this._x4=t,this._y4=e);break;case 2:this._point=3,this._x5=t,this._y5=e;break;default:gr(this,t,e);break}this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var eg=function t(e){function r(i){return new oo(i,e)}return r.tension=function(i){return t(+i)},r}(0);function no(t,e){this._context=t,this._k=(1-e)/6}no.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:gr(this,t,e);break}this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var rg=function t(e){function r(i){return new no(i,e)}return r.tension=function(i){return t(+i)},r}(0);function jr(t,e,r){var i=t._x1,o=t._y1,n=t._x2,a=t._y2;if(t._l01_a>gt){var s=2*t._l01_2a+3*t._l01_a*t._l12_a+t._l12_2a,h=3*t._l01_a*(t._l01_a+t._l12_a);i=(i*s-t._x0*t._l12_2a+t._x2*t._l01_2a)/h,o=(o*s-t._y0*t._l12_2a+t._y2*t._l01_2a)/h}if(t._l23_a>gt){var l=2*t._l23_2a+3*t._l23_a*t._l12_a+t._l12_2a,c=3*t._l23_a*(t._l23_a+t._l12_a);n=(n*l+t._x1*t._l23_2a-e*t._l12_2a)/c,a=(a*l+t._y1*t._l23_2a-r*t._l12_2a)/c}t._context.bezierCurveTo(i,o,n,a,t._x2,t._y2)}function qh(t,e){this._context=t,this._alpha=e}qh.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:this.point(this._x2,this._y2);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){if(t=+t,e=+e,this._point){var r=this._x2-t,i=this._y2-e;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(r*r+i*i,this._alpha))}switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;break;case 2:this._point=3;default:jr(this,t,e);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var ig=function t(e){function r(i){return e?new qh(i,e):new io(i,0)}return r.alpha=function(i){return t(+i)},r}(.5);function Ph(t,e){this._context=t,this._alpha=e}Ph.prototype={areaStart:$t,areaEnd:$t,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(t,e){if(t=+t,e=+e,this._point){var r=this._x2-t,i=this._y2-e;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(r*r+i*i,this._alpha))}switch(this._point){case 0:this._point=1,this._x3=t,this._y3=e;break;case 1:this._point=2,this._context.moveTo(this._x4=t,this._y4=e);break;case 2:this._point=3,this._x5=t,this._y5=e;break;default:jr(this,t,e);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var og=function t(e){function r(i){return e?new Ph(i,e):new oo(i,0)}return r.alpha=function(i){return t(+i)},r}(.5);function $h(t,e){this._context=t,this._alpha=e}$h.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){if(t=+t,e=+e,this._point){var r=this._x2-t,i=this._y2-e;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(r*r+i*i,this._alpha))}switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:jr(this,t,e);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=t,this._y0=this._y1,this._y1=this._y2,this._y2=e}};var ng=function t(e){function r(i){return e?new $h(i,e):new no(i,0)}return r.alpha=function(i){return t(+i)},r}(.5);function Wh(t){this._context=t}Wh.prototype={areaStart:$t,areaEnd:$t,lineStart:function(){this._point=0},lineEnd:function(){this._point&&this._context.closePath()},point:function(t,e){t=+t,e=+e,this._point?this._context.lineTo(t,e):(this._point=1,this._context.moveTo(t,e))}};function ag(t){return new Wh(t)}function Hh(t){return t<0?-1:1}function Uh(t,e,r){var i=t._x1-t._x0,o=e-t._x1,n=(t._y1-t._y0)/(i||o<0&&-0),a=(r-t._y1)/(o||i<0&&-0),s=(n*o+a*i)/(i+o);return(Hh(n)+Hh(a))*Math.min(Math.abs(n),Math.abs(a),.5*Math.abs(s))||0}function Yh(t,e){var r=t._x1-t._x0;return r?(3*(t._y1-t._y0)/r-e)/2:e}function Xn(t,e,r){var i=t._x0,o=t._y0,n=t._x1,a=t._y1,s=(n-i)/3;t._context.bezierCurveTo(i+s,o+s*e,n-s,a-s*r,n,a)}function ao(t){this._context=t}ao.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=this._t0=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x1,this._y1);break;case 3:Xn(this,this._t0,Yh(this,this._t0));break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){var r=NaN;if(t=+t,e=+e,!(t===this._x1&&e===this._y1)){switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;break;case 2:this._point=3,Xn(this,Yh(this,r=Uh(this,t,e)),r);break;default:Xn(this,this._t0,r=Uh(this,t,e));break}this._x0=this._x1,this._x1=t,this._y0=this._y1,this._y1=e,this._t0=r}}};function Gh(t){this._context=new Vh(t)}(Gh.prototype=Object.create(ao.prototype)).point=function(t,e){ao.prototype.point.call(this,e,t)};function Vh(t){this._context=t}Vh.prototype={moveTo:function(t,e){this._context.moveTo(e,t)},closePath:function(){this._context.closePath()},lineTo:function(t,e){this._context.lineTo(e,t)},bezierCurveTo:function(t,e,r,i,o,n){this._context.bezierCurveTo(e,t,i,r,n,o)}};function sg(t){return new ao(t)}function lg(t){return new Gh(t)}function jh(t){this._context=t}jh.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=[],this._y=[]},lineEnd:function(){var t=this._x,e=this._y,r=t.length;if(r)if(this._line?this._context.lineTo(t[0],e[0]):this._context.moveTo(t[0],e[0]),r===2)this._context.lineTo(t[1],e[1]);else for(var i=Xh(t),o=Xh(e),n=0,a=1;a<r;++n,++a)this._context.bezierCurveTo(i[0][n],o[0][n],i[1][n],o[1][n],t[a],e[a]);(this._line||this._line!==0&&r===1)&&this._context.closePath(),this._line=1-this._line,this._x=this._y=null},point:function(t,e){this._x.push(+t),this._y.push(+e)}};function Xh(t){var e,r=t.length-1,i,o=new Array(r),n=new Array(r),a=new Array(r);for(o[0]=0,n[0]=2,a[0]=t[0]+2*t[1],e=1;e<r-1;++e)o[e]=1,n[e]=4,a[e]=4*t[e]+2*t[e+1];for(o[r-1]=2,n[r-1]=7,a[r-1]=8*t[r-1]+t[r],e=1;e<r;++e)i=o[e]/n[e-1],n[e]-=i,a[e]-=i*a[e-1];for(o[r-1]=a[r-1]/n[r-1],e=r-2;e>=0;--e)o[e]=(a[e]-o[e+1])/n[e];for(n[r-1]=(t[r]+o[r-1])/2,e=0;e<r-1;++e)n[e]=2*t[e+1]-o[e+1];return[o,n]}function hg(t){return new jh(t)}function so(t,e){this._context=t,this._t=e}so.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=this._y=NaN,this._point=0},lineEnd:function(){0<this._t&&this._t<1&&this._point===2&&this._context.lineTo(this._x,this._y),(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line>=0&&(this._t=1-this._t,this._line=1-this._line)},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;default:{if(this._t<=0)this._context.lineTo(this._x,e),this._context.lineTo(t,e);else{var r=this._x*(1-this._t)+t*this._t;this._context.lineTo(r,this._y),this._context.lineTo(r,e)}break}}this._x=t,this._y=e}};function cg(t){return new so(t,.5)}function ug(t){return new so(t,0)}function fg(t){return new so(t,1)}var mg={value:()=>{}};function Kh(){for(var t=0,e=arguments.length,r={},i;t<e;++t){if(!(i=arguments[t]+"")||i in r||/[\s.]/.test(i))throw new Error("illegal type: "+i);r[i]=[]}return new lo(r)}function lo(t){this._=t}function dg(t,e){return t.trim().split(/^|\s+/).map(function(r){var i="",o=r.indexOf(".");if(o>=0&&(i=r.slice(o+1),r=r.slice(0,o)),r&&!e.hasOwnProperty(r))throw new Error("unknown type: "+r);return{type:r,name:i}})}lo.prototype=Kh.prototype={constructor:lo,on:function(t,e){var r=this._,i=dg(t+"",r),o,n=-1,a=i.length;if(arguments.length<2){for(;++n<a;)if((o=(t=i[n]).type)&&(o=pg(r[o],t.name)))return o;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++n<a;)if(o=(t=i[n]).type)r[o]=Zh(r[o],t.name,e);else if(e==null)for(o in r)r[o]=Zh(r[o],t.name,null);return this},copy:function(){var t={},e=this._;for(var r in e)t[r]=e[r].slice();return new lo(t)},call:function(t,e){if((o=arguments.length-2)>0)for(var r=new Array(o),i=0,o,n;i<o;++i)r[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(n=this._[t],i=0,o=n.length;i<o;++i)n[i].value.apply(e,r)},apply:function(t,e,r){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],o=0,n=i.length;o<n;++o)i[o].value.apply(e,r)}};function pg(t,e){for(var r=0,i=t.length,o;r<i;++r)if((o=t[r]).name===e)return o.value}function Zh(t,e,r){for(var i=0,o=t.length;i<o;++i)if(t[i].name===e){t[i]=mg,t=t.slice(0,i).concat(t.slice(i+1));break}return r!=null&&t.push({name:e,value:r}),t}var jn=Kh;var xr=0,Kr=0,Zr=0,Jh=1e3,ho,Qr,co=0,Ye=0,uo=0,Jr=typeof performance=="object"&&performance.now?performance:Date,tc=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function ei(){return Ye||(tc(gg),Ye=Jr.now()+uo)}function gg(){Ye=0}function ti(){this._call=this._time=this._next=null}ti.prototype=fo.prototype={constructor:ti,restart:function(t,e,r){if(typeof t!="function")throw new TypeError("callback is not a function");r=(r==null?ei():+r)+(e==null?0:+e),!this._next&&Qr!==this&&(Qr?Qr._next=this:ho=this,Qr=this),this._call=t,this._time=r,Zn()},stop:function(){this._call&&(this._call=null,this._time=1/0,Zn())}};function fo(t,e,r){var i=new ti;return i.restart(t,e,r),i}function ec(){ei(),++xr;for(var t=ho,e;t;)(e=Ye-t._time)>=0&&t._call.call(void 0,e),t=t._next;--xr}function Qh(){Ye=(co=Jr.now())+uo,xr=Kr=0;try{ec()}finally{xr=0,yg(),Ye=0}}function xg(){var t=Jr.now(),e=t-co;e>Jh&&(uo-=e,co=t)}function yg(){for(var t,e=ho,r,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(r=e._next,e._next=null,e=t?t._next=r:ho=r);Qr=t,Zn(i)}function Zn(t){if(!xr){Kr&&(Kr=clearTimeout(Kr));var e=t-Ye;e>24?(t<1/0&&(Kr=setTimeout(Qh,t-Jr.now()-uo)),Zr&&(Zr=clearInterval(Zr))):(Zr||(co=Jr.now(),Zr=setInterval(xg,Jh)),xr=1,tc(Qh))}}function mo(t,e,r){var i=new ti;return e=e==null?0:+e,i.restart(o=>{i.stop(),t(o+e)},e,r),i}var Cg=jn("start","end","cancel","interrupt"),_g=[],oc=0,rc=1,go=2,po=3,ic=4,xo=5,ri=6;function Te(t,e,r,i,o,n){var a=t.__transition;if(!a)t.__transition={};else if(r in a)return;bg(t,r,{name:e,index:i,group:o,on:Cg,tween:_g,time:n.time,delay:n.delay,duration:n.duration,ease:n.ease,timer:null,state:oc})}function ii(t,e){var r=ft(t,e);if(r.state>oc)throw new Error("too late; already scheduled");return r}function vt(t,e){var r=ft(t,e);if(r.state>po)throw new Error("too late; already running");return r}function ft(t,e){var r=t.__transition;if(!r||!(r=r[e]))throw new Error("transition not found");return r}function bg(t,e,r){var i=t.__transition,o;i[e]=r,r.timer=fo(n,0,r.time);function n(l){r.state=rc,r.timer.restart(a,r.delay,r.time),r.delay<=l&&a(l-r.delay)}function a(l){var c,d,u,p;if(r.state!==rc)return h();for(c in i)if(p=i[c],p.name===r.name){if(p.state===po)return mo(a);p.state===ic?(p.state=ri,p.timer.stop(),p.on.call("interrupt",t,t.__data__,p.index,p.group),delete i[c]):+c<e&&(p.state=ri,p.timer.stop(),p.on.call("cancel",t,t.__data__,p.index,p.group),delete i[c])}if(mo(function(){r.state===po&&(r.state=ic,r.timer.restart(s,r.delay,r.time),s(l))}),r.state=go,r.on.call("start",t,t.__data__,r.index,r.group),r.state===go){for(r.state=po,o=new Array(u=r.tween.length),c=0,d=-1;c<u;++c)(p=r.tween[c].value.call(t,t.__data__,r.index,r.group))&&(o[++d]=p);o.length=d+1}}function s(l){for(var c=l<r.duration?r.ease.call(null,l/r.duration):(r.timer.restart(h),r.state=xo,1),d=-1,u=o.length;++d<u;)o[d].call(t,c);r.state===xo&&(r.on.call("end",t,t.__data__,r.index,r.group),h())}function h(){r.state=ri,r.timer.stop(),delete i[e];for(var l in i)return;delete t.__transition}}function yo(t,e){var r=t.__transition,i,o,n=!0,a;if(r){e=e==null?null:e+"";for(a in r){if((i=r[a]).name!==e){n=!1;continue}o=i.state>go&&i.state<xo,i.state=ri,i.timer.stop(),i.on.call(o?"interrupt":"cancel",t,t.__data__,i.index,i.group),delete r[a]}n&&delete t.__transition}}function nc(t){return this.each(function(){yo(this,t)})}function Tg(t,e){var r,i;return function(){var o=vt(this,t),n=o.tween;if(n!==r){i=r=n;for(var a=0,s=i.length;a<s;++a)if(i[a].name===e){i=i.slice(),i.splice(a,1);break}}o.tween=i}}function kg(t,e,r){var i,o;if(typeof r!="function")throw new Error;return function(){var n=vt(this,t),a=n.tween;if(a!==i){o=(i=a).slice();for(var s={name:e,value:r},h=0,l=o.length;h<l;++h)if(o[h].name===e){o[h]=s;break}h===l&&o.push(s)}n.tween=o}}function ac(t,e){var r=this._id;if(t+="",arguments.length<2){for(var i=ft(this.node(),r).tween,o=0,n=i.length,a;o<n;++o)if((a=i[o]).name===t)return a.value;return null}return this.each((e==null?Tg:kg)(r,t,e))}function yr(t,e,r){var i=t._id;return t.each(function(){var o=vt(this,i);(o.value||(o.value={}))[e]=r.apply(this,arguments)}),function(o){return ft(o,i).value[e]}}function Co(t,e){var r;return(typeof e=="number"?kt:e instanceof Yt?De:(r=Yt(e))?(e=r,De):qr)(t,e)}function Sg(t){return function(){this.removeAttribute(t)}}function vg(t){return function(){this.removeAttributeNS(t.space,t.local)}}function wg(t,e,r){var i,o=r+"",n;return function(){var a=this.getAttribute(t);return a===o?null:a===i?n:n=e(i=a,r)}}function Bg(t,e,r){var i,o=r+"",n;return function(){var a=this.getAttributeNS(t.space,t.local);return a===o?null:a===i?n:n=e(i=a,r)}}function Fg(t,e,r){var i,o,n;return function(){var a,s=r(this),h;return s==null?void this.removeAttribute(t):(a=this.getAttribute(t),h=s+"",a===h?null:a===i&&h===o?n:(o=h,n=e(i=a,s)))}}function Lg(t,e,r){var i,o,n;return function(){var a,s=r(this),h;return s==null?void this.removeAttributeNS(t.space,t.local):(a=this.getAttributeNS(t.space,t.local),h=s+"",a===h?null:a===i&&h===o?n:(o=h,n=e(i=a,s)))}}function sc(t,e){var r=ae(t),i=r==="transform"?yn:Co;return this.attrTween(t,typeof e=="function"?(r.local?Lg:Fg)(r,i,yr(this,"attr."+t,e)):e==null?(r.local?vg:Sg)(r):(r.local?Bg:wg)(r,i,e))}function Mg(t,e){return function(r){this.setAttribute(t,e.call(this,r))}}function Ag(t,e){return function(r){this.setAttributeNS(t.space,t.local,e.call(this,r))}}function Eg(t,e){var r,i;function o(){var n=e.apply(this,arguments);return n!==i&&(r=(i=n)&&Ag(t,n)),r}return o._value=e,o}function Dg(t,e){var r,i;function o(){var n=e.apply(this,arguments);return n!==i&&(r=(i=n)&&Mg(t,n)),r}return o._value=e,o}function lc(t,e){var r="attr."+t;if(arguments.length<2)return(r=this.tween(r))&&r._value;if(e==null)return this.tween(r,null);if(typeof e!="function")throw new Error;var i=ae(t);return this.tween(r,(i.local?Eg:Dg)(i,e))}function Og(t,e){return function(){ii(this,t).delay=+e.apply(this,arguments)}}function Ig(t,e){return e=+e,function(){ii(this,t).delay=e}}function hc(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?Og:Ig)(e,t)):ft(this.node(),e).delay}function Ng(t,e){return function(){vt(this,t).duration=+e.apply(this,arguments)}}function Rg(t,e){return e=+e,function(){vt(this,t).duration=e}}function cc(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?Ng:Rg)(e,t)):ft(this.node(),e).duration}function zg(t,e){if(typeof e!="function")throw new Error;return function(){vt(this,t).ease=e}}function uc(t){var e=this._id;return arguments.length?this.each(zg(e,t)):ft(this.node(),e).ease}function qg(t,e){return function(){var r=e.apply(this,arguments);if(typeof r!="function")throw new Error;vt(this,t).ease=r}}function fc(t){if(typeof t!="function")throw new Error;return this.each(qg(this._id,t))}function mc(t){typeof t!="function"&&(t=Or(t));for(var e=this._groups,r=e.length,i=new Array(r),o=0;o<r;++o)for(var n=e[o],a=n.length,s=i[o]=[],h,l=0;l<a;++l)(h=n[l])&&t.call(h,h.__data__,l,n)&&s.push(h);return new Dt(i,this._parents,this._name,this._id)}function dc(t){if(t._id!==this._id)throw new Error;for(var e=this._groups,r=t._groups,i=e.length,o=r.length,n=Math.min(i,o),a=new Array(i),s=0;s<n;++s)for(var h=e[s],l=r[s],c=h.length,d=a[s]=new Array(c),u,p=0;p<c;++p)(u=h[p]||l[p])&&(d[p]=u);for(;s<i;++s)a[s]=e[s];return new Dt(a,this._parents,this._name,this._id)}function Pg(t){return(t+"").trim().split(/^|\s+/).every(function(e){var r=e.indexOf(".");return r>=0&&(e=e.slice(0,r)),!e||e==="start"})}function $g(t,e,r){var i,o,n=Pg(e)?ii:vt;return function(){var a=n(this,t),s=a.on;s!==i&&(o=(i=s).copy()).on(e,r),a.on=o}}function pc(t,e){var r=this._id;return arguments.length<2?ft(this.node(),r).on.on(t):this.each($g(r,t,e))}function Wg(t){return function(){var e=this.parentNode;for(var r in this.__transition)if(+r!==t)return;e&&e.removeChild(this)}}function gc(){return this.on("end.remove",Wg(this._id))}function xc(t){var e=this._name,r=this._id;typeof t!="function"&&(t=Le(t));for(var i=this._groups,o=i.length,n=new Array(o),a=0;a<o;++a)for(var s=i[a],h=s.length,l=n[a]=new Array(h),c,d,u=0;u<h;++u)(c=s[u])&&(d=t.call(c,c.__data__,u,s))&&("__data__"in c&&(d.__data__=c.__data__),l[u]=d,Te(l[u],e,r,u,l,ft(c,r)));return new Dt(n,this._parents,e,r)}function yc(t){var e=this._name,r=this._id;typeof t!="function"&&(t=Dr(t));for(var i=this._groups,o=i.length,n=[],a=[],s=0;s<o;++s)for(var h=i[s],l=h.length,c,d=0;d<l;++d)if(c=h[d]){for(var u=t.call(c,c.__data__,d,h),p,T=ft(c,r),M=0,$=u.length;M<$;++M)(p=u[M])&&Te(p,e,r,M,u,T);n.push(u),a.push(c)}return new Dt(n,a,e,r)}var Hg=se.prototype.constructor;function Cc(){return new Hg(this._groups,this._parents)}function Ug(t,e){var r,i,o;return function(){var n=pe(this,t),a=(this.style.removeProperty(t),pe(this,t));return n===a?null:n===r&&a===i?o:o=e(r=n,i=a)}}function _c(t){return function(){this.style.removeProperty(t)}}function Yg(t,e,r){var i,o=r+"",n;return function(){var a=pe(this,t);return a===o?null:a===i?n:n=e(i=a,r)}}function Gg(t,e,r){var i,o,n;return function(){var a=pe(this,t),s=r(this),h=s+"";return s==null&&(h=s=(this.style.removeProperty(t),pe(this,t))),a===h?null:a===i&&h===o?n:(o=h,n=e(i=a,s))}}function Vg(t,e){var r,i,o,n="style."+e,a="end."+n,s;return function(){var h=vt(this,t),l=h.on,c=h.value[n]==null?s||(s=_c(e)):void 0;(l!==r||o!==c)&&(i=(r=l).copy()).on(a,o=c),h.on=i}}function bc(t,e,r){var i=(t+="")=="transform"?xn:Co;return e==null?this.styleTween(t,Ug(t,i)).on("end.style."+t,_c(t)):typeof e=="function"?this.styleTween(t,Gg(t,i,yr(this,"style."+t,e))).each(Vg(this._id,t)):this.styleTween(t,Yg(t,i,e),r).on("end.style."+t,null)}function Xg(t,e,r){return function(i){this.style.setProperty(t,e.call(this,i),r)}}function jg(t,e,r){var i,o;function n(){var a=e.apply(this,arguments);return a!==o&&(i=(o=a)&&Xg(t,a,r)),i}return n._value=e,n}function Tc(t,e,r){var i="style."+(t+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(e==null)return this.tween(i,null);if(typeof e!="function")throw new Error;return this.tween(i,jg(t,e,r??""))}function Zg(t){return function(){this.textContent=t}}function Kg(t){return function(){var e=t(this);this.textContent=e??""}}function kc(t){return this.tween("text",typeof t=="function"?Kg(yr(this,"text",t)):Zg(t==null?"":t+""))}function Qg(t){return function(e){this.textContent=t.call(this,e)}}function Jg(t){var e,r;function i(){var o=t.apply(this,arguments);return o!==r&&(e=(r=o)&&Qg(o)),e}return i._value=t,i}function Sc(t){var e="text";if(arguments.length<1)return(e=this.tween(e))&&e._value;if(t==null)return this.tween(e,null);if(typeof t!="function")throw new Error;return this.tween(e,Jg(t))}function vc(){for(var t=this._name,e=this._id,r=_o(),i=this._groups,o=i.length,n=0;n<o;++n)for(var a=i[n],s=a.length,h,l=0;l<s;++l)if(h=a[l]){var c=ft(h,e);Te(h,t,r,l,a,{time:c.time+c.delay+c.duration,delay:0,duration:c.duration,ease:c.ease})}return new Dt(i,this._parents,t,r)}function wc(){var t,e,r=this,i=r._id,o=r.size();return new Promise(function(n,a){var s={value:a},h={value:function(){--o===0&&n()}};r.each(function(){var l=vt(this,i),c=l.on;c!==t&&(e=(t=c).copy(),e._.cancel.push(s),e._.interrupt.push(s),e._.end.push(h)),l.on=e}),o===0&&n()})}var tx=0;function Dt(t,e,r,i){this._groups=t,this._parents=e,this._name=r,this._id=i}function Bc(t){return se().transition(t)}function _o(){return++tx}var fe=se.prototype;Dt.prototype=Bc.prototype={constructor:Dt,select:xc,selectAll:yc,selectChild:fe.selectChild,selectChildren:fe.selectChildren,filter:mc,merge:dc,selection:Cc,transition:vc,call:fe.call,nodes:fe.nodes,node:fe.node,size:fe.size,empty:fe.empty,each:fe.each,on:pc,attr:sc,attrTween:lc,style:bc,styleTween:Tc,text:kc,textTween:Sc,remove:gc,tween:ac,delay:hc,duration:cc,ease:uc,easeVarying:fc,end:wc,[Symbol.iterator]:fe[Symbol.iterator]};function bo(t){return((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2}var ex={time:null,delay:0,duration:250,ease:bo};function rx(t,e){for(var r;!(r=t.__transition)||!(r=r[e]);)if(!(t=t.parentNode))throw new Error(`transition ${e} not found`);return r}function Fc(t){var e,r;t instanceof Dt?(e=t._id,t=t._name):(e=_o(),(r=ex).time=ei(),t=t==null?null:t+"");for(var i=this._groups,o=i.length,n=0;n<o;++n)for(var a=i[n],s=a.length,h,l=0;l<s;++l)(h=a[l])&&Te(h,t,e,l,a,r||rx(h,e));return new Dt(i,this._parents,t,e)}se.prototype.interrupt=nc;se.prototype.transition=Fc;var{abs:X2,max:j2,min:Z2}=Math;function Lc(t){return[+t[0],+t[1]]}function ix(t){return[Lc(t[0]),Lc(t[1])]}var K2={name:"x",handles:["w","e"].map(Kn),input:function(t,e){return t==null?null:[[+t[0],e[0][1]],[+t[1],e[1][1]]]},output:function(t){return t&&[t[0][0],t[1][0]]}},Q2={name:"y",handles:["n","s"].map(Kn),input:function(t,e){return t==null?null:[[e[0][0],+t[0]],[e[1][0],+t[1]]]},output:function(t){return t&&[t[0][1],t[1][1]]}},J2={name:"xy",handles:["n","w","e","s","nw","ne","sw","se"].map(Kn),input:function(t){return t==null?null:ix(t)},output:function(t){return t}};function Kn(t){return{type:t}}function ke(t,e,r){this.k=t,this.x=e,this.y=r}ke.prototype={constructor:ke,scale:function(t){return t===1?this:new ke(this.k*t,this.x,this.y)},translate:function(t,e){return t===0&e===0?this:new ke(this.k,this.x+this.k*t,this.y+this.k*e)},apply:function(t){return[t[0]*this.k+this.x,t[1]*this.k+this.y]},applyX:function(t){return t*this.k+this.x},applyY:function(t){return t*this.k+this.y},invert:function(t){return[(t[0]-this.x)/this.k,(t[1]-this.y)/this.k]},invertX:function(t){return(t-this.x)/this.k},invertY:function(t){return(t-this.y)/this.k},rescaleX:function(t){return t.copy().domain(t.range().map(this.invertX,this).map(t.invert,t))},rescaleY:function(t){return t.copy().domain(t.range().map(this.invertY,this).map(t.invert,t))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};var Qn=new ke(1,0,0);Jn.prototype=ke.prototype;function Jn(t){for(;!t.__zoom;)if(!(t=t.parentNode))return Qn;return t.__zoom}export{ya as a,oe as b,Xc as c,Wt as d,A as e,I as f,Ze as g,y as h,vu as i,it as j,wu as k,Bu as l,Fu as m,Mu as n,Ci as o,B0 as p,F0 as q,L0 as r,Rt as s,Nu as t,Ke as u,Wu as v,$o as w,ki as x,N0 as y,R0 as z,z0 as A,q0 as B,Uu as C,Uo as D,P0 as E,$0 as F,Ar as G,Mr as H,tf as I,H0 as J,Ga as K,U0 as L,af as M,Y0 as N,hf as O,cf as P,G0 as Q,ns as R,mf as S,df as T,pf as U,gf as V,xf as W,yf as X,Cf as Y,as as Z,V0 as _,X0 as $,bf as aa,Tf as ba,j0 as ca,Z0 as da,ss as ea,ls as fa,qf as ga,Pf as ha,Rm as ia,Km as ja,Pr as ka,_n as la,Dn as ma,Ne as na,Jt as oa,sr as pa,lr as qa,ce as ra,ue as sa,hr as ta,jl as ua,Zl as va,Ce as wa,Kl as xa,Ql as ya,ur as za,Ki as Aa,vh as Ba,Np as Ca,Yp as Da,Vn as Ea,Gp as Fa,Vp as Ga,jp as Ha,Zp as Ia,Xp as Ja,Kp as Ka,Qp as La,Jp as Ma,tg as Na,eg as Oa,rg as Pa,ig as Qa,og as Ra,ng as Sa,ag as Ta,sg as Ua,lg as Va,hg as Wa,cg as Xa,ug as Ya,fg as Za};
